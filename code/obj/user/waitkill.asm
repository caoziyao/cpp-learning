...
umain(int argc, char *argv[]) {
  ...
  8007aa:	e8 ff 0e 00 00       	call   8016ae <main>
...
exit(int error_code) {
  ...
  8008bc:	68 64 18 80 00       	push   $0x801864
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800f7b:	05 84 1a 80 00       	add    $0x801a84,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  8010cc:	8b 04 85 a8 1a 80 00 	mov    0x801aa8(,%eax,4),%eax
  ...
  8011ce:	56                   	push   %esi
  8011cf:	68 9e 1a 80 00       	push   $0x801a9e
  ...
  8011f7:	75 05                	jne    8011fe <vprintfmt+0x1a3>
                p = "(null)";
  8011f9:	be a1 1a 80 00       	mov    $0x801aa1,%esi
            }
            if (width > 0 && padc != '-') {
...
do_yield(void) {
  ...
  8015f4:	83 ec 08             	sub    $0x8,%esp
    yield();
  8015f7:	e8 0c f3 ff ff       	call   800908 <yield>
    yield();
  8015fc:	e8 07 f3 ff ff       	call   800908 <yield>
    yield();
  801601:	e8 02 f3 ff ff       	call   800908 <yield>
    yield();
  801606:	e8 fd f2 ff ff       	call   800908 <yield>
    yield();
  80160b:	e8 f8 f2 ff ff       	call   800908 <yield>
    yield();
  801610:	e8 f3 f2 ff ff       	call   800908 <yield>
}
  801615:	90                   	nop
  801616:	c9                   	leave  
  801617:	c3                   	ret    
...
loop(void) {
  ...
  801621:	68 00 1c 80 00       	push   $0x801c00
  801626:	e8 aa ef ff ff       	call   8005d5 <cprintf>
  80162b:	83 c4 10             	add    $0x10,%esp
    while (1);
  80162e:	eb fe                	jmp    80162e <loop+0x16>
...
work(void) {
  ...
  801639:	68 0a 1c 80 00       	push   $0x801c0a
  80163e:	e8 92 ef ff ff       	call   8005d5 <cprintf>
  801643:	83 c4 10             	add    $0x10,%esp
    do_yield();
  801646:	e8 a6 ff ff ff       	call   8015f1 <do_yield>
    if (kill(parent) == 0) {
  80164b:	a1 48 21 80 00       	mov    0x802148,%eax
  801650:	83 ec 0c             	sub    $0xc,%esp
  801653:	50                   	push   %eax
  801654:	e8 bd f2 ff ff       	call   800916 <kill>
  801659:	83 c4 10             	add    $0x10,%esp
  80165c:	85 c0                	test   %eax,%eax
  80165e:	75 44                	jne    8016a4 <work+0x74>
        cprintf("kill parent ok.\n");
  801660:	83 ec 0c             	sub    $0xc,%esp
  801663:	68 14 1c 80 00       	push   $0x801c14
  801668:	e8 68 ef ff ff       	call   8005d5 <cprintf>
  80166d:	83 c4 10             	add    $0x10,%esp
        do_yield();
  801670:	e8 7c ff ff ff       	call   8015f1 <do_yield>
        if (kill(pid1) == 0) {
  801675:	a1 50 21 80 00       	mov    0x802150,%eax
  80167a:	83 ec 0c             	sub    $0xc,%esp
  80167d:	50                   	push   %eax
  80167e:	e8 93 f2 ff ff       	call   800916 <kill>
  801683:	83 c4 10             	add    $0x10,%esp
  801686:	85 c0                	test   %eax,%eax
  801688:	75 1a                	jne    8016a4 <work+0x74>
            cprintf("kill child1 ok.\n");
  80168a:	83 ec 0c             	sub    $0xc,%esp
  80168d:	68 25 1c 80 00       	push   $0x801c25
  801692:	e8 3e ef ff ff       	call   8005d5 <cprintf>
  801697:	83 c4 10             	add    $0x10,%esp
            exit(0);
  80169a:	83 ec 0c             	sub    $0xc,%esp
  80169d:	6a 00                	push   $0x0
  80169f:	e8 01 f2 ff ff       	call   8008a5 <exit>
        }
    }
    exit(-1);
  8016a4:	83 ec 0c             	sub    $0xc,%esp
  8016a7:	6a ff                	push   $0xffffffff
  8016a9:	e8 f7 f1 ff ff       	call   8008a5 <exit>
...
int
main(void) {
  8016ae:	8d 4c 24 04          	lea    0x4(%esp),%ecx
  8016b2:	83 e4 f0             	and    $0xfffffff0,%esp
  8016b5:	ff 71 fc             	pushl  -0x4(%ecx)
  8016b8:	55                   	push   %ebp
  8016b9:	89 e5                	mov    %esp,%ebp
  8016bb:	51                   	push   %ecx
  8016bc:	83 ec 04             	sub    $0x4,%esp
    parent = getpid();
  8016bf:	e8 68 f2 ff ff       	call   80092c <getpid>
  8016c4:	a3 48 21 80 00       	mov    %eax,0x802148
    if ((pid1 = fork()) == 0) {
  8016c9:	e8 fd f1 ff ff       	call   8008cb <fork>
  8016ce:	a3 50 21 80 00       	mov    %eax,0x802150
  8016d3:	a1 50 21 80 00       	mov    0x802150,%eax
  8016d8:	85 c0                	test   %eax,%eax
  8016da:	75 05                	jne    8016e1 <main+0x33>
        loop();
  8016dc:	e8 37 ff ff ff       	call   801618 <loop>
    }

    assert(pid1 > 0);
  8016e1:	a1 50 21 80 00       	mov    0x802150,%eax
  8016e6:	85 c0                	test   %eax,%eax
  8016e8:	7f 16                	jg     801700 <main+0x52>
  8016ea:	68 36 1c 80 00       	push   $0x801c36
  8016ef:	68 3f 1c 80 00       	push   $0x801c3f
  8016f4:	6a 2c                	push   $0x2c
  8016f6:	68 54 1c 80 00       	push   $0x801c54
  8016fb:	e8 20 e9 ff ff       	call   800020 <__panic>

    if ((pid2 = fork()) == 0) {
  801700:	e8 c6 f1 ff ff       	call   8008cb <fork>
  801705:	a3 4c 21 80 00       	mov    %eax,0x80214c
  80170a:	a1 4c 21 80 00       	mov    0x80214c,%eax
  80170f:	85 c0                	test   %eax,%eax
  801711:	75 05                	jne    801718 <main+0x6a>
        work();
  801713:	e8 18 ff ff ff       	call   801630 <work>
    }
    if (pid2 > 0) {
  801718:	a1 4c 21 80 00       	mov    0x80214c,%eax
  80171d:	85 c0                	test   %eax,%eax
  80171f:	7e 3a                	jle    80175b <main+0xad>
        cprintf("wait child 1.\n");
  801721:	83 ec 0c             	sub    $0xc,%esp
  801724:	68 64 1c 80 00       	push   $0x801c64
  801729:	e8 a7 ee ff ff       	call   8005d5 <cprintf>
  80172e:	83 c4 10             	add    $0x10,%esp
        waitpid(pid1, NULL);
  801731:	a1 50 21 80 00       	mov    0x802150,%eax
  801736:	83 ec 08             	sub    $0x8,%esp
  801739:	6a 00                	push   $0x0
  80173b:	50                   	push   %eax
  80173c:	e8 ae f1 ff ff       	call   8008ef <waitpid>
  801741:	83 c4 10             	add    $0x10,%esp
        panic("waitpid %d returns\n", pid1);
  801744:	a1 50 21 80 00       	mov    0x802150,%eax
  801749:	50                   	push   %eax
  80174a:	68 73 1c 80 00       	push   $0x801c73
  80174f:	6a 34                	push   $0x34
  801751:	68 54 1c 80 00       	push   $0x801c54
  801756:	e8 c5 e8 ff ff       	call   800020 <__panic>
    }
    else {
        kill(pid1);
  80175b:	a1 50 21 80 00       	mov    0x802150,%eax
  801760:	83 ec 0c             	sub    $0xc,%esp
  801763:	50                   	push   %eax
  801764:	e8 ad f1 ff ff       	call   800916 <kill>
  801769:	83 c4 10             	add    $0x10,%esp
    }
    panic("FAIL: T.T\n");
  80176c:	83 ec 04             	sub    $0x4,%esp
  80176f:	68 87 1c 80 00       	push   $0x801c87
  801774:	6a 39                	push   $0x39
  801776:	68 54 1c 80 00       	push   $0x801c54
  80177b:	e8 a0 e8 ff ff       	call   800020 <__panic>
