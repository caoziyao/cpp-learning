...
main(void) {
  ...
  80161e:	75 12                	jne    801632 <main+0x41>
        cprintf("I am the child. spinning ...\n");
  801620:	83 ec 0c             	sub    $0xc,%esp
  801623:	68 a7 1b 80 00       	push   $0x801ba7
  801628:	e8 a8 ef ff ff       	call   8005d5 <cprintf>
  80162d:	83 c4 10             	add    $0x10,%esp
        while (1);
  801630:	eb fe                	jmp    801630 <main+0x3f>
    }
    cprintf("I am the parent. Running the child...\n");
  801632:	83 ec 0c             	sub    $0xc,%esp
  801635:	68 c8 1b 80 00       	push   $0x801bc8
  80163a:	e8 96 ef ff ff       	call   8005d5 <cprintf>
  80163f:	83 c4 10             	add    $0x10,%esp

    yield();
  801642:	e8 c1 f2 ff ff       	call   800908 <yield>
    yield();
  801647:	e8 bc f2 ff ff       	call   800908 <yield>
    yield();
  80164c:	e8 b7 f2 ff ff       	call   800908 <yield>

    cprintf("I am the parent.  Killing the child...\n");
  801651:	83 ec 0c             	sub    $0xc,%esp
  801654:	68 f0 1b 80 00       	push   $0x801bf0
  ...
  801667:	e8 aa f2 ff ff       	call   800916 <kill>
  80166c:	83 c4 10             	add    $0x10,%esp
  80166f:	89 45 f0             	mov    %eax,-0x10(%ebp)
  801672:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
  801676:	74 16                	je     80168e <main+0x9d>
  801678:	68 18 1c 80 00       	push   $0x801c18
  80167d:	68 2f 1c 80 00       	push   $0x801c2f
  801682:	6a 14                	push   $0x14
  801684:	68 44 1c 80 00       	push   $0x801c44
  801689:	e8 92 e9 ff ff       	call   800020 <__panic>
    cprintf("kill returns %d\n", ret);
  80168e:	83 ec 08             	sub    $0x8,%esp
  801691:	ff 75 f0             	pushl  -0x10(%ebp)
  801694:	68 50 1c 80 00       	push   $0x801c50
  801699:	e8 37 ef ff ff       	call   8005d5 <cprintf>
  ...
  8016a9:	e8 41 f2 ff ff       	call   8008ef <waitpid>
  8016ae:	83 c4 10             	add    $0x10,%esp
  8016b1:	89 45 f0             	mov    %eax,-0x10(%ebp)
  8016b4:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
  8016b8:	74 16                	je     8016d0 <main+0xdf>
  8016ba:	68 64 1c 80 00       	push   $0x801c64
  8016bf:	68 2f 1c 80 00       	push   $0x801c2f
  8016c4:	6a 17                	push   $0x17
  8016c6:	68 44 1c 80 00       	push   $0x801c44
  8016cb:	e8 50 e9 ff ff       	call   800020 <__panic>
    cprintf("wait returns %d\n", ret);
  8016d0:	83 ec 08             	sub    $0x8,%esp
  8016d3:	ff 75 f0             	pushl  -0x10(%ebp)
  8016d6:	68 84 1c 80 00       	push   $0x801c84
  8016db:	e8 f5 ee ff ff       	call   8005d5 <cprintf>
  8016e0:	83 c4 10             	add    $0x10,%esp

    cprintf("spin may pass.\n");
  8016e3:	83 ec 0c             	sub    $0xc,%esp
  8016e6:	68 95 1c 80 00       	push   $0x801c95
  8016eb:	e8 e5 ee ff ff       	call   8005d5 <cprintf>
  8016f0:	83 c4 10             	add    $0x10,%esp
    return 0;
  8016f3:	b8 00 00 00 00       	mov    $0x0,%eax
}
  8016f8:	8b 4d fc             	mov    -0x4(%ebp),%ecx
  8016fb:	c9                   	leave  
  8016fc:	8d 61 fc             	lea    -0x4(%ecx),%esp
  8016ff:	c3                   	ret    
