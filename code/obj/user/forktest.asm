...
exit(int error_code) {
  ...
  8008bc:	68 c4 17 80 00       	push   $0x8017c4
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800f7b:	05 e4 19 80 00       	add    $0x8019e4,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  8010cc:	8b 04 85 08 1a 80 00 	mov    0x801a08(,%eax,4),%eax
  ...
  8011ce:	56                   	push   %esi
  8011cf:	68 fe 19 80 00       	push   $0x8019fe
  ...
  8011f7:	75 05                	jne    8011fe <vprintfmt+0x1a3>
                p = "(null)";
  8011f9:	be 01 1a 80 00       	mov    $0x801a01,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  801609:	eb 4b                	jmp    801656 <main+0x65>
        if ((pid = fork()) == 0) {
  80160b:	e8 bb f2 ff ff       	call   8008cb <fork>
  801610:	89 45 f0             	mov    %eax,-0x10(%ebp)
  801613:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
  801617:	75 1d                	jne    801636 <main+0x45>
            cprintf("I am child %d\n", n);
  801619:	83 ec 08             	sub    $0x8,%esp
  80161c:	ff 75 f4             	pushl  -0xc(%ebp)
  80161f:	68 64 1b 80 00       	push   $0x801b64
  801624:	e8 ac ef ff ff       	call   8005d5 <cprintf>
  801629:	83 c4 10             	add    $0x10,%esp
            exit(0);
  80162c:	83 ec 0c             	sub    $0xc,%esp
  80162f:	6a 00                	push   $0x0
  801631:	e8 6f f2 ff ff       	call   8008a5 <exit>
        }
        assert(pid > 0);
  801636:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
  80163a:	7f 16                	jg     801652 <main+0x61>
  80163c:	68 73 1b 80 00       	push   $0x801b73
  801641:	68 7b 1b 80 00       	push   $0x801b7b
  801646:	6a 0e                	push   $0xe
  801648:	68 90 1b 80 00       	push   $0x801b90
...
main(void) {
    int n, pid;
    for (n = 0; n < max_child; n ++) {
  801652:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  801656:	b8 20 00 00 00       	mov    $0x20,%eax
  80165b:	39 45 f4             	cmp    %eax,-0xc(%ebp)
  80165e:	7c ab                	jl     80160b <main+0x1a>
            exit(0);
        }
        assert(pid > 0);
    }
    ...
    if (n > max_child) {
  801660:	b8 20 00 00 00       	mov    $0x20,%eax
  801665:	39 45 f4             	cmp    %eax,-0xc(%ebp)
  801668:	7e 35                	jle    80169f <main+0xae>
        panic("fork claimed to work %d times!\n", n);
  80166a:	ff 75 f4             	pushl  -0xc(%ebp)
  80166d:	68 a0 1b 80 00       	push   $0x801ba0
  801672:	6a 12                	push   $0x12
  801674:	68 90 1b 80 00       	push   $0x801b90
  801679:	e8 a2 e9 ff ff       	call   800020 <__panic>
    }

    for (; n > 0; n --) {
        if (wait() != 0) {
  80167e:	e8 55 f2 ff ff       	call   8008d8 <wait>
  801683:	85 c0                	test   %eax,%eax
  801685:	74 14                	je     80169b <main+0xaa>
            panic("wait stopped early\n");
  801687:	83 ec 04             	sub    $0x4,%esp
  80168a:	68 c0 1b 80 00       	push   $0x801bc0
  80168f:	6a 17                	push   $0x17
  801691:	68 90 1b 80 00       	push   $0x801b90
  801696:	e8 85 e9 ff ff       	call   800020 <__panic>
    ...
    for (; n > 0; n --) {
  80169b:	83 6d f4 01          	subl   $0x1,-0xc(%ebp)
  80169f:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
  8016a3:	7f d9                	jg     80167e <main+0x8d>
        if (wait() != 0) {
            panic("wait stopped early\n");
        }
    }
    ...
    if (wait() == 0) {
  8016a5:	e8 2e f2 ff ff       	call   8008d8 <wait>
  8016aa:	85 c0                	test   %eax,%eax
  8016ac:	75 14                	jne    8016c2 <main+0xd1>
        panic("wait got too many\n");
  8016ae:	83 ec 04             	sub    $0x4,%esp
  8016b1:	68 d4 1b 80 00       	push   $0x801bd4
  8016b6:	6a 1c                	push   $0x1c
  8016b8:	68 90 1b 80 00       	push   $0x801b90
  8016bd:	e8 5e e9 ff ff       	call   800020 <__panic>
    }

    cprintf("forktest pass.\n");
  8016c2:	83 ec 0c             	sub    $0xc,%esp
  8016c5:	68 e7 1b 80 00       	push   $0x801be7
  8016ca:	e8 06 ef ff ff       	call   8005d5 <cprintf>
  8016cf:	83 c4 10             	add    $0x10,%esp
    return 0;
  8016d2:	b8 00 00 00 00       	mov    $0x0,%eax
}
  8016d7:	8b 4d fc             	mov    -0x4(%ebp),%ecx
  8016da:	c9                   	leave  
  8016db:	8d 61 fc             	lea    -0x4(%ecx),%esp
  8016de:	c3                   	ret    
