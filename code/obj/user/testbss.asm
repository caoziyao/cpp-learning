...
exit(int error_code) {
  ...
  8008bc:	68 e4 17 80 00       	push   $0x8017e4
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800f7b:	05 04 1a 80 00       	add    $0x801a04,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  8010cc:	8b 04 85 28 1a 80 00 	mov    0x801a28(,%eax,4),%eax
  ...
  8011ce:	56                   	push   %esi
  8011cf:	68 1e 1a 80 00       	push   $0x801a1e
  ...
  8011f7:	75 05                	jne    8011fe <vprintfmt+0x1a3>
                p = "(null)";
  8011f9:	be 21 1a 80 00       	mov    $0x801a21,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  801605:	68 80 1b 80 00       	push   $0x801b80
  80160a:	e8 c6 ef ff ff       	call   8005d5 <cprintf>
  80160f:	83 c4 10             	add    $0x10,%esp
    int i;
    for (i = 0; i < ARRAYSIZE; i ++) {
  801612:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  801619:	eb 26                	jmp    801641 <main+0x50>
        if (bigarray[i] != 0) {
  80161b:	8b 45 f4             	mov    -0xc(%ebp),%eax
  80161e:	8b 04 85 60 21 80 00 	mov    0x802160(,%eax,4),%eax
  801625:	85 c0                	test   %eax,%eax
  801627:	74 14                	je     80163d <main+0x4c>
            panic("bigarray[%d] isn't cleared!\n", i);
  801629:	ff 75 f4             	pushl  -0xc(%ebp)
  80162c:	68 a0 1b 80 00       	push   $0x801ba0
  801631:	6a 0e                	push   $0xe
  801633:	68 bd 1b 80 00       	push   $0x801bbd
...
main(void) {
    ...
    int i;
    for (i = 0; i < ARRAYSIZE; i ++) {
  80163d:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  801641:	81 7d f4 ff ff 0f 00 	cmpl   $0xfffff,-0xc(%ebp)
  801648:	7e d1                	jle    80161b <main+0x2a>
        if (bigarray[i] != 0) {
            panic("bigarray[%d] isn't cleared!\n", i);
        }
    }
  ...
  801651:	eb 11                	jmp    801664 <main+0x73>
        bigarray[i] = i;
  801653:	8b 55 f4             	mov    -0xc(%ebp),%edx
  801656:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801659:	89 14 85 60 21 80 00 	mov    %edx,0x802160(,%eax,4)
    for (i = 0; i < ARRAYSIZE; i ++) {
        if (bigarray[i] != 0) {
            panic("bigarray[%d] isn't cleared!\n", i);
        }
    ...
    for (i = 0; i < ARRAYSIZE; i ++) {
  801660:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  801664:	81 7d f4 ff ff 0f 00 	cmpl   $0xfffff,-0xc(%ebp)
  80166b:	7e e6                	jle    801653 <main+0x62>
        bigarray[i] = i;
    }
    for (i = 0; i < ARRAYSIZE; i ++) {
  80166d:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  801674:	eb 29                	jmp    80169f <main+0xae>
        if (bigarray[i] != i) {
  801676:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801679:	8b 14 85 60 21 80 00 	mov    0x802160(,%eax,4),%edx
  ...
  80168a:	68 cc 1b 80 00       	push   $0x801bcc
  80168f:	6a 16                	push   $0x16
  801691:	68 bd 1b 80 00       	push   $0x801bbd
  801696:	e8 85 e9 ff ff       	call   800020 <__panic>
    ...
    for (i = 0; i < ARRAYSIZE; i ++) {
  80169b:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  80169f:	81 7d f4 ff ff 0f 00 	cmpl   $0xfffff,-0xc(%ebp)
  8016a6:	7e ce                	jle    801676 <main+0x85>
        if (bigarray[i] != i) {
            panic("bigarray[%d] didn't hold its value!\n", i);
        }
    }
  ...
  8016ab:	68 f4 1b 80 00       	push   $0x801bf4
  8016b0:	e8 20 ef ff ff       	call   8005d5 <cprintf>
  8016b5:	83 c4 10             	add    $0x10,%esp
    cprintf("testbss may pass.\n");
  8016b8:	83 ec 0c             	sub    $0xc,%esp
  8016bb:	68 27 1c 80 00       	push   $0x801c27
  8016c0:	e8 10 ef ff ff       	call   8005d5 <cprintf>
  8016c5:	83 c4 10             	add    $0x10,%esp

    bigarray[ARRAYSIZE + 1024] = 0;
  8016c8:	c7 05 60 31 c0 00 00 	movl   $0x0,0xc03160
  8016cf:	00 00 00 
    asm volatile ("int $0x14");
  8016d2:	cd 14                	int    $0x14
    panic("FAIL: T.T\n");
  8016d4:	83 ec 04             	sub    $0x4,%esp
  8016d7:	68 3a 1c 80 00       	push   $0x801c3a
  8016dc:	6a 1f                	push   $0x1f
  8016de:	68 bd 1b 80 00       	push   $0x801bbd
  8016e3:	e8 38 e9 ff ff       	call   800020 <__panic>
