...
obj/__user_ls.out:     file format elf32-i386
...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800035:	68 a0 19 80 00       	push   $0x8019a0
  ...
  800057:	68 ba 19 80 00       	push   $0x8019ba
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  800083:	68 bc 19 80 00       	push   $0x8019bc
  ...
  8000a5:	68 ba 19 80 00       	push   $0x8019ba
...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  800509:	68 d8 19 80 00       	push   $0x8019d8
  ...
  80052a:	50                   	push   %eax
  80052b:	68 e3 19 80 00       	push   $0x8019e3
  ...
  800541:	50                   	push   %eax
  800542:	68 f5 19 80 00       	push   $0x8019f5
  ...
  800558:	50                   	push   %eax
  800559:	68 08 1a 80 00       	push   $0x801a08
  ...
  80056f:	50                   	push   %eax
  800570:	68 1b 1a 80 00       	push   $0x801a1b
...
umain(int argc, char *argv[]) {
  ...
  80073e:	68 2e 1a 80 00       	push   $0x801a2e
  ...
  800759:	68 35 1a 80 00       	push   $0x801a35
  80075e:	6a 1a                	push   $0x1a
  800760:	68 4f 1a 80 00       	push   $0x801a4f
  ...
  800772:	68 61 1a 80 00       	push   $0x801a61
  ...
  80078d:	68 69 1a 80 00       	push   $0x801a69
  800792:	6a 1d                	push   $0x1d
  800794:	68 4f 1a 80 00       	push   $0x801a4f
  ...
  8007aa:	e8 66 11 00 00       	call   801915 <main>
...
lock_fork(void) {
  ...
  800882:	68 40 20 80 00       	push   $0x802040
...
unlock_fork(void) {
  ...
  800893:	89 e5                	mov    %esp,%ebp
    unlock(&fork_lock);
  800895:	68 40 20 80 00       	push   $0x802040
...
exit(int error_code) {
  ...
  8008bc:	68 84 1a 80 00       	push   $0x801a84
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800f7b:	05 a4 1c 80 00       	add    $0x801ca4,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  8010cc:	8b 04 85 c8 1c 80 00 	mov    0x801cc8(,%eax,4),%eax
  ...
  8011ce:	56                   	push   %esi
  8011cf:	68 be 1c 80 00       	push   $0x801cbe
  ...
  8011f7:	75 05                	jne    8011fe <vprintfmt+0x1a3>
                p = "(null)";
  8011f9:	be c1 1c 80 00       	mov    $0x801cc1,%esi
            }
            if (width > 0 && padc != '-') {
...
getmode(uint32_t st_mode) {
  ...
  8015f4:	83 ec 10             	sub    $0x10,%esp
    char mode = '?';
  8015f7:	c6 45 ff 3f          	movb   $0x3f,-0x1(%ebp)
    if (S_ISREG(st_mode)) mode = '-';
  8015fb:	8b 45 08             	mov    0x8(%ebp),%eax
  8015fe:	25 00 70 00 00       	and    $0x7000,%eax
  801603:	3d 00 10 00 00       	cmp    $0x1000,%eax
  801608:	75 04                	jne    80160e <getmode+0x1d>
  80160a:	c6 45 ff 2d          	movb   $0x2d,-0x1(%ebp)
    if (S_ISDIR(st_mode)) mode = 'd';
  80160e:	8b 45 08             	mov    0x8(%ebp),%eax
  801611:	25 00 70 00 00       	and    $0x7000,%eax
  801616:	3d 00 20 00 00       	cmp    $0x2000,%eax
  80161b:	75 04                	jne    801621 <getmode+0x30>
  80161d:	c6 45 ff 64          	movb   $0x64,-0x1(%ebp)
    if (S_ISLNK(st_mode)) mode = 'l';
  801621:	8b 45 08             	mov    0x8(%ebp),%eax
  801624:	25 00 70 00 00       	and    $0x7000,%eax
  801629:	3d 00 30 00 00       	cmp    $0x3000,%eax
  80162e:	75 04                	jne    801634 <getmode+0x43>
  801630:	c6 45 ff 6c          	movb   $0x6c,-0x1(%ebp)
    if (S_ISCHR(st_mode)) mode = 'c';
  801634:	8b 45 08             	mov    0x8(%ebp),%eax
  801637:	25 00 70 00 00       	and    $0x7000,%eax
  80163c:	3d 00 40 00 00       	cmp    $0x4000,%eax
  801641:	75 04                	jne    801647 <getmode+0x56>
  801643:	c6 45 ff 63          	movb   $0x63,-0x1(%ebp)
    if (S_ISBLK(st_mode)) mode = 'b';
  801647:	8b 45 08             	mov    0x8(%ebp),%eax
  80164a:	25 00 70 00 00       	and    $0x7000,%eax
  80164f:	3d 00 50 00 00       	cmp    $0x5000,%eax
  801654:	75 04                	jne    80165a <getmode+0x69>
  801656:	c6 45 ff 62          	movb   $0x62,-0x1(%ebp)
    return mode;
  80165a:	0f b6 45 ff          	movzbl -0x1(%ebp),%eax
}
  80165e:	c9                   	leave  
  80165f:	c3                   	ret    
...
lsstat(struct stat *stat, const char *filename) {
  ...
  8016b6:	50                   	push   %eax
  8016b7:	e8 35 ff ff ff       	call   8015f1 <getmode>
  8016bc:	83 c4 04             	add    $0x4,%esp
  8016bf:	0f be c0             	movsbl %al,%eax
  8016c2:	83 ec 04             	sub    $0x4,%esp
  8016c5:	50                   	push   %eax
  8016c6:	68 20 1e 80 00       	push   $0x801e20
  8016cb:	6a 01                	push   $0x1
  8016cd:	e8 d6 ef ff ff       	call   8006a8 <fprintf>
  ...
  8016de:	50                   	push   %eax
  8016df:	68 28 1e 80 00       	push   $0x801e28
  8016e4:	6a 01                	push   $0x1
  8016e6:	e8 bd ef ff ff       	call   8006a8 <fprintf>
  ...
  8016f7:	50                   	push   %eax
  8016f8:	68 30 1e 80 00       	push   $0x801e30
  8016fd:	6a 01                	push   $0x1
  8016ff:	e8 a4 ef ff ff       	call   8006a8 <fprintf>
  ...
  801710:	50                   	push   %eax
  801711:	68 38 1e 80 00       	push   $0x801e38
  801716:	6a 01                	push   $0x1
  801718:	e8 8b ef ff ff       	call   8006a8 <fprintf>
  80171d:	83 c4 10             	add    $0x10,%esp
    printf("   %s\n", filename);
  801720:	83 ec 04             	sub    $0x4,%esp
  801723:	ff 75 0c             	pushl  0xc(%ebp)
  801726:	68 40 1e 80 00       	push   $0x801e40
  80172b:	6a 01                	push   $0x1
  80172d:	e8 76 ef ff ff       	call   8006a8 <fprintf>
...
lsdir(const char *path) {
  ...
  80173b:	83 ec 28             	sub    $0x28,%esp
    struct stat __stat, *stat = &__stat;
  80173e:	8d 45 d8             	lea    -0x28(%ebp),%eax
  801741:	89 45 f4             	mov    %eax,-0xc(%ebp)
    int ret;
    DIR *dirp = opendir(".");
  801744:	83 ec 0c             	sub    $0xc,%esp
  801747:	68 47 1e 80 00       	push   $0x801e47
  80174c:	e8 6b eb ff ff       	call   8002bc <opendir>
  801751:	83 c4 10             	add    $0x10,%esp
  801754:	89 45 f0             	mov    %eax,-0x10(%ebp)
    
    if (dirp == NULL) {
  801757:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
  80175b:	75 3d                	jne    80179a <lsdir+0x62>
        return -1;
  80175d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  801762:	e9 83 00 00 00       	jmp    8017ea <lsdir+0xb2>
    }
  ...
  801773:	50                   	push   %eax
  801774:	e8 e7 fe ff ff       	call   801660 <getstat>
  801779:	83 c4 10             	add    $0x10,%esp
  80177c:	89 45 e8             	mov    %eax,-0x18(%ebp)
  80177f:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
  801783:	75 53                	jne    8017d8 <lsdir+0xa0>
            goto failed;
        }
  ...
  801792:	e8 14 ff ff ff       	call   8016ab <lsstat>
  ...
  8017a0:	e8 8b eb ff ff       	call   800330 <readdir>
  8017a5:	83 c4 10             	add    $0x10,%esp
  8017a8:	89 45 ec             	mov    %eax,-0x14(%ebp)
  8017ab:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
  8017af:	75 b6                	jne    801767 <lsdir+0x2f>
        if ((ret = getstat(direntp->name, stat)) != 0) {
            goto failed;
        }
        lsstat(stat, direntp->name);
...
failed:
  ...
  8017df:	e8 7d eb ff ff       	call   800361 <closedir>
...
ls(const char *path) {
  ...
  8017ef:	83 ec 28             	sub    $0x28,%esp
    struct stat __stat, *stat = &__stat;
  8017f2:	8d 45 dc             	lea    -0x24(%ebp),%eax
  ...
  801822:	50                   	push   %eax
  801823:	e8 c9 fd ff ff       	call   8015f1 <getmode>
  801828:	83 c4 10             	add    $0x10,%esp
  80182b:	0f be c0             	movsbl %al,%eax
  80182e:	83 f8 63             	cmp    $0x63,%eax
  801831:	74 38                	je     80186b <ls+0x7f>
  801833:	83 f8 63             	cmp    $0x63,%eax
  801836:	7f 0c                	jg     801844 <ls+0x58>
  801838:	83 f8 30             	cmp    $0x30,%eax
  80183b:	74 13                	je     801850 <ls+0x64>
  80183d:	83 f8 62             	cmp    $0x62,%eax
  801840:	74 32                	je     801874 <ls+0x88>
  801842:	eb 39                	jmp    80187d <ls+0x91>
  801844:	83 f8 64             	cmp    $0x64,%eax
  801847:	74 10                	je     801859 <ls+0x6d>
  801849:	83 f8 6c             	cmp    $0x6c,%eax
  80184c:	74 14                	je     801862 <ls+0x76>
  80184e:	eb 2d                	jmp    80187d <ls+0x91>
    case '0': type = 0; break;
  801850:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  801857:	eb 2c                	jmp    801885 <ls+0x99>
    case 'd': type = 1; break;
  801859:	c7 45 f4 01 00 00 00 	movl   $0x1,-0xc(%ebp)
  801860:	eb 23                	jmp    801885 <ls+0x99>
    case 'l': type = 2; break;
  801862:	c7 45 f4 02 00 00 00 	movl   $0x2,-0xc(%ebp)
  801869:	eb 1a                	jmp    801885 <ls+0x99>
    case 'c': type = 3; break;
  80186b:	c7 45 f4 03 00 00 00 	movl   $0x3,-0xc(%ebp)
  801872:	eb 11                	jmp    801885 <ls+0x99>
    case 'b': type = 4; break;
  801874:	c7 45 f4 04 00 00 00 	movl   $0x4,-0xc(%ebp)
  80187b:	eb 08                	jmp    801885 <ls+0x99>
    default:  type = 5; break;
  80187d:	c7 45 f4 05 00 00 00 	movl   $0x5,-0xc(%ebp)
  801884:	90                   	nop
    }

    printf(" @ is %s", filetype[type]);
  801885:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801888:	8b 04 85 10 20 80 00 	mov    0x802010(,%eax,4),%eax
  80188f:	83 ec 04             	sub    $0x4,%esp
  801892:	50                   	push   %eax
  801893:	68 58 1e 80 00       	push   $0x801e58
  801898:	6a 01                	push   $0x1
  80189a:	e8 09 ee ff ff       	call   8006a8 <fprintf>
  ...
  8018ab:	50                   	push   %eax
  8018ac:	68 61 1e 80 00       	push   $0x801e61
  8018b1:	6a 01                	push   $0x1
  8018b3:	e8 f0 ed ff ff       	call   8006a8 <fprintf>
  ...
  8018c4:	50                   	push   %eax
  8018c5:	68 6d 1e 80 00       	push   $0x801e6d
  8018ca:	6a 01                	push   $0x1
  8018cc:	e8 d7 ed ff ff       	call   8006a8 <fprintf>
  ...
  8018dd:	50                   	push   %eax
  8018de:	68 79 1e 80 00       	push   $0x801e79
  8018e3:	6a 01                	push   $0x1
  8018e5:	e8 be ed ff ff       	call   8006a8 <fprintf>
  8018ea:	83 c4 10             	add    $0x10,%esp
    if (S_ISDIR(stat->st_mode)) {
  8018ed:	8b 45 f0             	mov    -0x10(%ebp),%eax
  8018f0:	8b 00                	mov    (%eax),%eax
  8018f2:	25 00 70 00 00       	and    $0x7000,%eax
  8018f7:	3d 00 20 00 00       	cmp    $0x2000,%eax
  8018fc:	75 10                	jne    80190e <ls+0x122>
        return lsdir(path);
  8018fe:	83 ec 0c             	sub    $0xc,%esp
  801901:	ff 75 08             	pushl  0x8(%ebp)
  801904:	e8 2f fe ff ff       	call   801738 <lsdir>
  801909:	83 c4 10             	add    $0x10,%esp
  80190c:	eb 05                	jmp    801913 <ls+0x127>
    }
    return 0;
...
main(int argc, char **argv) {
  801915:	8d 4c 24 04          	lea    0x4(%esp),%ecx
  801919:	83 e4 f0             	and    $0xfffffff0,%esp
  80191c:	ff 71 fc             	pushl  -0x4(%ecx)
  80191f:	55                   	push   %ebp
  801920:	89 e5                	mov    %esp,%ebp
  801922:	53                   	push   %ebx
  801923:	51                   	push   %ecx
  801924:	83 ec 10             	sub    $0x10,%esp
  801927:	89 cb                	mov    %ecx,%ebx
    if (argc == 1) {
  801929:	83 3b 01             	cmpl   $0x1,(%ebx)
  80192c:	75 12                	jne    801940 <main+0x2b>
        return ls(".");
  80192e:	83 ec 0c             	sub    $0xc,%esp
  801931:	68 47 1e 80 00       	push   $0x801e47
  801936:	e8 b1 fe ff ff       	call   8017ec <ls>
  80193b:	83 c4 10             	add    $0x10,%esp
  80193e:	eb 44                	jmp    801984 <main+0x6f>
    }
    else {
        int i, ret;
        for (i = 1; i < argc; i ++) {
  801940:	c7 45 f4 01 00 00 00 	movl   $0x1,-0xc(%ebp)
  801947:	eb 2f                	jmp    801978 <main+0x63>
            if ((ret = ls(argv[i])) != 0) {
  ...
  80195d:	50                   	push   %eax
  80195e:	e8 89 fe ff ff       	call   8017ec <ls>
  801963:	83 c4 10             	add    $0x10,%esp
  801966:	89 45 f0             	mov    %eax,-0x10(%ebp)
  801969:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
  80196d:	74 05                	je     801974 <main+0x5f>
                return ret;
  80196f:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801972:	eb 10                	jmp    801984 <main+0x6f>
    if (argc == 1) {
        return ls(".");
    }
    else {
        int i, ret;
        for (i = 1; i < argc; i ++) {
  801974:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  801978:	8b 45 f4             	mov    -0xc(%ebp),%eax
  80197b:	3b 03                	cmp    (%ebx),%eax
  80197d:	7c ca                	jl     801949 <main+0x34>
            if ((ret = ls(argv[i])) != 0) {
                return ret;
            }
        }
  ...
  801988:	5b                   	pop    %ebx
  801989:	5d                   	pop    %ebp
  80198a:	8d 61 fc             	lea    -0x4(%ecx),%esp
  80198d:	c3                   	ret    
