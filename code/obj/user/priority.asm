...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800035:	68 e0 18 80 00       	push   $0x8018e0
  ...
  800057:	68 fa 18 80 00       	push   $0x8018fa
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  800083:	68 fc 18 80 00       	push   $0x8018fc
  ...
  8000a5:	68 fa 18 80 00       	push   $0x8018fa
...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  800509:	68 18 19 80 00       	push   $0x801918
  ...
  80052a:	50                   	push   %eax
  80052b:	68 23 19 80 00       	push   $0x801923
  ...
  800541:	50                   	push   %eax
  800542:	68 35 19 80 00       	push   $0x801935
  ...
  800558:	50                   	push   %eax
  800559:	68 48 19 80 00       	push   $0x801948
  ...
  80056f:	50                   	push   %eax
  800570:	68 5b 19 80 00       	push   $0x80195b
...
umain(int argc, char *argv[]) {
  ...
  80073e:	68 6e 19 80 00       	push   $0x80196e
  ...
  800759:	68 75 19 80 00       	push   $0x801975
  80075e:	6a 1a                	push   $0x1a
  800760:	68 8f 19 80 00       	push   $0x80198f
  ...
  800772:	68 a1 19 80 00       	push   $0x8019a1
  ...
  80078d:	68 a9 19 80 00       	push   $0x8019a9
  800792:	6a 1d                	push   $0x1d
  800794:	68 8f 19 80 00       	push   $0x80198f
  ...
  8007aa:	e8 6f 0e 00 00       	call   80161e <main>
...
exit(int error_code) {
  ...
  8008bc:	68 c4 19 80 00       	push   $0x8019c4
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800f7b:	05 e4 1b 80 00       	add    $0x801be4,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  8010cc:	8b 04 85 08 1c 80 00 	mov    0x801c08(,%eax,4),%eax
  ...
  8011ce:	56                   	push   %esi
  8011cf:	68 fe 1b 80 00       	push   $0x801bfe
  ...
  8011f7:	75 05                	jne    8011fe <vprintfmt+0x1a3>
                p = "(null)";
  8011f9:	be 01 1c 80 00       	mov    $0x801c01,%esi
            }
            if (width > 0 && padc != '-') {
...
spin_delay(void)
{
  ...
  8015fe:	eb 12                	jmp    801612 <spin_delay+0x21>
     {
          j = !j;
...
spin_delay(void)
{
     ...
     volatile int j;
     for (i = 0; i != 200; ++ i)
  80160e:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
  801612:	81 7d fc c8 00 00 00 	cmpl   $0xc8,-0x4(%ebp)
  801619:	75 e5                	jne    801600 <spin_delay+0xf>
     {
          j = !j;
     }
}
...
int
main(void) {
  80161e:	8d 4c 24 04          	lea    0x4(%esp),%ecx
  801622:	83 e4 f0             	and    $0xfffffff0,%esp
  801625:	ff 71 fc             	pushl  -0x4(%ecx)
  801628:	55                   	push   %ebp
  ...
  801633:	68 90 01 00 00       	push   $0x190
  801638:	68 60 1d 80 00       	push   $0x801d60
  80163d:	e8 93 ef ff ff       	call   8005d5 <cprintf>
  801642:	83 c4 10             	add    $0x10,%esp
     sleep(SLEEP_TIME);
  801645:	83 ec 0c             	sub    $0xc,%esp
  801648:	68 90 01 00 00       	push   $0x190
  80164d:	e8 0c f3 ff ff       	call   80095e <sleep>
  801652:	83 c4 10             	add    $0x10,%esp
     memset(pids, 0, sizeof(pids));
  801655:	83 ec 04             	sub    $0x4,%esp
  801658:	6a 14                	push   $0x14
  80165a:	6a 00                	push   $0x0
  80165c:	68 70 21 80 00       	push   $0x802170
  801661:	e8 b3 f6 ff ff       	call   800d19 <memset>
  801666:	83 c4 10             	add    $0x10,%esp
     lab6_set_priority(TOTAL + 1);
  801669:	83 ec 0c             	sub    $0xc,%esp
  80166c:	6a 06                	push   $0x6
  80166e:	e8 d4 f2 ff ff       	call   800947 <lab6_set_priority>
  801673:	83 c4 10             	add    $0x10,%esp

     for (i = 0; i < TOTAL; i ++) {
  801676:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  80167d:	e9 ee 00 00 00       	jmp    801770 <main+0x152>
          acc[i]=0;
  801682:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801685:	c7 04 85 48 21 80 00 	movl   $0x0,0x802148(,%eax,4)
  80168c:	00 00 00 00 
          if ((pids[i] = fork()) == 0) {
  801690:	e8 36 f2 ff ff       	call   8008cb <fork>
  801695:	89 c2                	mov    %eax,%edx
  801697:	8b 45 f4             	mov    -0xc(%ebp),%eax
  80169a:	89 14 85 70 21 80 00 	mov    %edx,0x802170(,%eax,4)
  8016a1:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8016a4:	8b 04 85 70 21 80 00 	mov    0x802170(,%eax,4),%eax
  8016ab:	85 c0                	test   %eax,%eax
  8016ad:	0f 85 a7 00 00 00    	jne    80175a <main+0x13c>
               lab6_set_priority(i + 1);
  8016b3:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8016b6:	83 c0 01             	add    $0x1,%eax
  8016b9:	83 ec 0c             	sub    $0xc,%esp
  8016bc:	50                   	push   %eax
  8016bd:	e8 85 f2 ff ff       	call   800947 <lab6_set_priority>
  8016c2:	83 c4 10             	add    $0x10,%esp
               acc[i] = 0;
  8016c5:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8016c8:	c7 04 85 48 21 80 00 	movl   $0x0,0x802148(,%eax,4)
  8016cf:	00 00 00 00 
               while (1) {
                    spin_delay();
  8016d3:	e8 19 ff ff ff       	call   8015f1 <spin_delay>
                    ++ acc[i];
  8016d8:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8016db:	8b 04 85 48 21 80 00 	mov    0x802148(,%eax,4),%eax
  8016e2:	8d 50 01             	lea    0x1(%eax),%edx
  8016e5:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8016e8:	89 14 85 48 21 80 00 	mov    %edx,0x802148(,%eax,4)
                    if(acc[i]%4000==0) {
  8016ef:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8016f2:	8b 0c 85 48 21 80 00 	mov    0x802148(,%eax,4),%ecx
  8016f9:	ba d3 4d 62 10       	mov    $0x10624dd3,%edx
  8016fe:	89 c8                	mov    %ecx,%eax
  801700:	f7 e2                	mul    %edx
  801702:	89 d0                	mov    %edx,%eax
  801704:	c1 e8 08             	shr    $0x8,%eax
  801707:	69 c0 a0 0f 00 00    	imul   $0xfa0,%eax,%eax
  80170d:	29 c1                	sub    %eax,%ecx
  80170f:	89 c8                	mov    %ecx,%eax
  801711:	85 c0                	test   %eax,%eax
  801713:	75 be                	jne    8016d3 <main+0xb5>
                        if((time=gettime_msec())>SLEEP_TIME+MAX_TIME) {
  801715:	e8 5a f2 ff ff       	call   800974 <gettime_msec>
  80171a:	89 45 f0             	mov    %eax,-0x10(%ebp)
  80171d:	81 7d f0 78 05 00 00 	cmpl   $0x578,-0x10(%ebp)
  801724:	7e ad                	jle    8016d3 <main+0xb5>
                            cprintf("child pid %d, acc %d, time %d\n",getpid(),acc[i],time);
  801726:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801729:	8b 1c 85 48 21 80 00 	mov    0x802148(,%eax,4),%ebx
  801730:	e8 f7 f1 ff ff       	call   80092c <getpid>
  801735:	ff 75 f0             	pushl  -0x10(%ebp)
  801738:	53                   	push   %ebx
  801739:	50                   	push   %eax
  80173a:	68 88 1d 80 00       	push   $0x801d88
  80173f:	e8 91 ee ff ff       	call   8005d5 <cprintf>
  801744:	83 c4 10             	add    $0x10,%esp
                            exit(acc[i]);
  801747:	8b 45 f4             	mov    -0xc(%ebp),%eax
  80174a:	8b 04 85 48 21 80 00 	mov    0x802148(,%eax,4),%eax
  801751:	83 ec 0c             	sub    $0xc,%esp
  801754:	50                   	push   %eax
  801755:	e8 4b f1 ff ff       	call   8008a5 <exit>
                        }
                    }
               }
  ...
  80175d:	8b 04 85 70 21 80 00 	mov    0x802170(,%eax,4),%eax
  801764:	85 c0                	test   %eax,%eax
  801766:	0f 88 09 01 00 00    	js     801875 <main+0x257>
     cprintf("priority process will sleep %d ticks\n",SLEEP_TIME);
     sleep(SLEEP_TIME);
     memset(pids, 0, sizeof(pids));
     lab6_set_priority(TOTAL + 1);
     ...
     for (i = 0; i < TOTAL; i ++) {
  80176c:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  801770:	83 7d f4 04          	cmpl   $0x4,-0xc(%ebp)
  801774:	0f 8e 08 ff ff ff    	jle    801682 <main+0x64>
          if (pids[i] < 0) {
               goto failed;
          }
     }
  ...
  80177d:	68 a8 1d 80 00       	push   $0x801da8
  801782:	e8 4e ee ff ff       	call   8005d5 <cprintf>
  801787:	83 c4 10             	add    $0x10,%esp

     for (i = 0; i < TOTAL; i ++) {
  80178a:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  801791:	eb 60                	jmp    8017f3 <main+0x1d5>
         status[i]=0;
  801793:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801796:	c7 04 85 5c 21 80 00 	movl   $0x0,0x80215c(,%eax,4)
  80179d:	00 00 00 00 
         waitpid(pids[i],&status[i]);
  8017a1:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8017a4:	c1 e0 02             	shl    $0x2,%eax
  8017a7:	8d 90 5c 21 80 00    	lea    0x80215c(%eax),%edx
  8017ad:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8017b0:	8b 04 85 70 21 80 00 	mov    0x802170(,%eax,4),%eax
  8017b7:	83 ec 08             	sub    $0x8,%esp
  8017ba:	52                   	push   %edx
  8017bb:	50                   	push   %eax
  8017bc:	e8 2e f1 ff ff       	call   8008ef <waitpid>
  8017c1:	83 c4 10             	add    $0x10,%esp
         cprintf("main: pid %d, acc %d, time %d\n",pids[i],status[i],gettime_msec()); 
  8017c4:	e8 ab f1 ff ff       	call   800974 <gettime_msec>
  8017c9:	89 c1                	mov    %eax,%ecx
  8017cb:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8017ce:	8b 14 85 5c 21 80 00 	mov    0x80215c(,%eax,4),%edx
  8017d5:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8017d8:	8b 04 85 70 21 80 00 	mov    0x802170(,%eax,4),%eax
  8017df:	51                   	push   %ecx
  8017e0:	52                   	push   %edx
  8017e1:	50                   	push   %eax
  8017e2:	68 d0 1d 80 00       	push   $0x801dd0
  8017e7:	e8 e9 ed ff ff       	call   8005d5 <cprintf>
  8017ec:	83 c4 10             	add    $0x10,%esp
     ...
     for (i = 0; i < TOTAL; i ++) {
  8017ef:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  8017f3:	83 7d f4 04          	cmpl   $0x4,-0xc(%ebp)
  8017f7:	7e 9a                	jle    801793 <main+0x175>
         status[i]=0;
         waitpid(pids[i],&status[i]);
         cprintf("main: pid %d, acc %d, time %d\n",pids[i],status[i],gettime_msec()); 
     }
  ...
  8017fc:	68 ef 1d 80 00       	push   $0x801def
  801801:	e8 cf ed ff ff       	call   8005d5 <cprintf>
  801806:	83 c4 10             	add    $0x10,%esp
     cprintf("stride sched correct result:");
  801809:	83 ec 0c             	sub    $0xc,%esp
  80180c:	68 05 1e 80 00       	push   $0x801e05
  801811:	e8 bf ed ff ff       	call   8005d5 <cprintf>
  801816:	83 c4 10             	add    $0x10,%esp
     for (i = 0; i < TOTAL; i ++)
  801819:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  801820:	eb 36                	jmp    801858 <main+0x23a>
     {
         cprintf(" %d", (status[i] * 2 / status[0] + 1) / 2);
  801822:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801825:	8b 04 85 5c 21 80 00 	mov    0x80215c(,%eax,4),%eax
  80182c:	01 c0                	add    %eax,%eax
  80182e:	8b 1d 5c 21 80 00    	mov    0x80215c,%ebx
  801834:	99                   	cltd   
  801835:	f7 fb                	idiv   %ebx
  801837:	83 c0 01             	add    $0x1,%eax
  80183a:	89 c2                	mov    %eax,%edx
  80183c:	c1 ea 1f             	shr    $0x1f,%edx
  80183f:	01 d0                	add    %edx,%eax
  801841:	d1 f8                	sar    %eax
  801843:	83 ec 08             	sub    $0x8,%esp
  801846:	50                   	push   %eax
  801847:	68 22 1e 80 00       	push   $0x801e22
  80184c:	e8 84 ed ff ff       	call   8005d5 <cprintf>
  801851:	83 c4 10             	add    $0x10,%esp
     ...
     cprintf("stride sched correct result:");
     for (i = 0; i < TOTAL; i ++)
  801854:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  801858:	83 7d f4 04          	cmpl   $0x4,-0xc(%ebp)
  80185c:	7e c4                	jle    801822 <main+0x204>
     {
         cprintf(" %d", (status[i] * 2 / status[0] + 1) / 2);
     }
     cprintf("\n");
  80185e:	83 ec 0c             	sub    $0xc,%esp
  801861:	68 26 1e 80 00       	push   $0x801e26
  801866:	e8 6a ed ff ff       	call   8005d5 <cprintf>
  80186b:	83 c4 10             	add    $0x10,%esp

     return 0;
  80186e:	b8 00 00 00 00       	mov    $0x0,%eax
  801873:	eb 4c                	jmp    8018c1 <main+0x2a3>
                    }
               }
...
failed:
  ...
  80187d:	eb 28                	jmp    8018a7 <main+0x289>
          if (pids[i] > 0) {
  80187f:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801882:	8b 04 85 70 21 80 00 	mov    0x802170(,%eax,4),%eax
  801889:	85 c0                	test   %eax,%eax
  80188b:	7e 16                	jle    8018a3 <main+0x285>
               kill(pids[i]);
  80188d:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801890:	8b 04 85 70 21 80 00 	mov    0x802170(,%eax,4),%eax
  801897:	83 ec 0c             	sub    $0xc,%esp
  80189a:	50                   	push   %eax
  80189b:	e8 76 f0 ff ff       	call   800916 <kill>
...
failed:
     for (i = 0; i < TOTAL; i ++) {
  8018a3:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  8018a7:	83 7d f4 04          	cmpl   $0x4,-0xc(%ebp)
  8018ab:	7e d2                	jle    80187f <main+0x261>
          if (pids[i] > 0) {
               kill(pids[i]);
          }
     }
  ...
  8018b0:	68 28 1e 80 00       	push   $0x801e28
  8018b5:	6a 4e                	push   $0x4e
  8018b7:	68 33 1e 80 00       	push   $0x801e33
  8018bc:	e8 5f e7 ff ff       	call   800020 <__panic>
}
  8018c1:	8d 65 f8             	lea    -0x8(%ebp),%esp
  8018c4:	59                   	pop    %ecx
  8018c5:	5b                   	pop    %ebx
  8018c6:	5d                   	pop    %ebp
  8018c7:	8d 61 fc             	lea    -0x4(%ecx),%esp
  8018ca:	c3                   	ret    
