...
exit(int error_code) {
  ...
  8008bc:	68 64 17 80 00       	push   $0x801764
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800f7b:	05 84 19 80 00       	add    $0x801984,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  8010cc:	8b 04 85 a8 19 80 00 	mov    0x8019a8(,%eax,4),%eax
  ...
  8011ce:	56                   	push   %esi
  8011cf:	68 9e 19 80 00       	push   $0x80199e
  ...
  8011f7:	75 05                	jne    8011fe <vprintfmt+0x1a3>
                p = "(null)";
  8011f9:	be a1 19 80 00       	mov    $0x8019a1,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  801602:	e8 25 f3 ff ff       	call   80092c <getpid>
  801607:	83 ec 08             	sub    $0x8,%esp
  80160a:	50                   	push   %eax
  80160b:	68 00 1b 80 00       	push   $0x801b00
  801610:	e8 c0 ef ff ff       	call   8005d5 <cprintf>
  801615:	83 c4 10             	add    $0x10,%esp
    for (i = 0; i < 5; i ++) {
  801618:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  80161f:	eb 22                	jmp    801643 <main+0x52>
        yield();
  801621:	e8 e2 f2 ff ff       	call   800908 <yield>
        cprintf("Back in process %d, iteration %d.\n", getpid(), i);
  801626:	e8 01 f3 ff ff       	call   80092c <getpid>
  80162b:	83 ec 04             	sub    $0x4,%esp
  80162e:	ff 75 f4             	pushl  -0xc(%ebp)
  801631:	50                   	push   %eax
  801632:	68 1c 1b 80 00       	push   $0x801b1c
  801637:	e8 99 ef ff ff       	call   8005d5 <cprintf>
...
main(void) {
    ...
    cprintf("Hello, I am process %d.\n", getpid());
    for (i = 0; i < 5; i ++) {
  80163f:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  801643:	83 7d f4 04          	cmpl   $0x4,-0xc(%ebp)
  801647:	7e d8                	jle    801621 <main+0x30>
        yield();
        cprintf("Back in process %d, iteration %d.\n", getpid(), i);
    }
    cprintf("All done in process %d.\n", getpid());
  801649:	e8 de f2 ff ff       	call   80092c <getpid>
  80164e:	83 ec 08             	sub    $0x8,%esp
  801651:	50                   	push   %eax
  801652:	68 3f 1b 80 00       	push   $0x801b3f
  801657:	e8 79 ef ff ff       	call   8005d5 <cprintf>
  80165c:	83 c4 10             	add    $0x10,%esp
    cprintf("yield pass.\n");
  80165f:	83 ec 0c             	sub    $0xc,%esp
  801662:	68 58 1b 80 00       	push   $0x801b58
  801667:	e8 69 ef ff ff       	call   8005d5 <cprintf>
  ...
  801677:	c9                   	leave  
  801678:	8d 61 fc             	lea    -0x4(%ecx),%esp
  80167b:	c3                   	ret    
