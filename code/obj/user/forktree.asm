...
umain(int argc, char *argv[]) {
  ...
  8007aa:	e8 eb 0e 00 00       	call   80169a <main>
...
forkchild(const char *cur, char branch) {
  ...
  801603:	e8 b7 f3 ff ff       	call   8009bf <strlen>
  801608:	83 c4 10             	add    $0x10,%esp
  80160b:	83 f8 03             	cmp    $0x3,%eax
  80160e:	77 45                	ja     801655 <forkchild+0x64>
        return;

    snprintf(nxt, DEPTH + 1, "%s%c", cur, branch);
  801610:	0f be 45 e4          	movsbl -0x1c(%ebp),%eax
  801614:	83 ec 0c             	sub    $0xc,%esp
  801617:	50                   	push   %eax
  801618:	ff 75 08             	pushl  0x8(%ebp)
  80161b:	68 80 1b 80 00       	push   $0x801b80
  801620:	6a 05                	push   $0x5
  801622:	8d 45 f3             	lea    -0xd(%ebp),%eax
  801625:	50                   	push   %eax
  801626:	e8 3e fe ff ff       	call   801469 <snprintf>
  80162b:	83 c4 20             	add    $0x20,%esp
    if (fork() == 0) {
  80162e:	e8 98 f2 ff ff       	call   8008cb <fork>
  801633:	85 c0                	test   %eax,%eax
  801635:	75 1f                	jne    801656 <forkchild+0x65>
        forktree(nxt);
  801637:	83 ec 0c             	sub    $0xc,%esp
  80163a:	8d 45 f3             	lea    -0xd(%ebp),%eax
  80163d:	50                   	push   %eax
  80163e:	e8 15 00 00 00       	call   801658 <forktree>
  801643:	83 c4 10             	add    $0x10,%esp
        yield();
  801646:	e8 bd f2 ff ff       	call   800908 <yield>
        exit(0);
  80164b:	83 ec 0c             	sub    $0xc,%esp
  80164e:	6a 00                	push   $0x0
  801650:	e8 50 f2 ff ff       	call   8008a5 <exit>
void
forkchild(const char *cur, char branch) {
    char nxt[DEPTH + 1];
...
forktree(const char *cur) {
  ...
  80165b:	83 ec 08             	sub    $0x8,%esp
    cprintf("%04x: I am '%s'\n", getpid(), cur);
  80165e:	e8 c9 f2 ff ff       	call   80092c <getpid>
  801663:	83 ec 04             	sub    $0x4,%esp
  801666:	ff 75 08             	pushl  0x8(%ebp)
  801669:	50                   	push   %eax
  80166a:	68 85 1b 80 00       	push   $0x801b85
  80166f:	e8 61 ef ff ff       	call   8005d5 <cprintf>
  ...
  80167f:	e8 6d ff ff ff       	call   8015f1 <forkchild>
  801684:	83 c4 10             	add    $0x10,%esp
    forkchild(cur, '1');
  801687:	83 ec 08             	sub    $0x8,%esp
  80168a:	6a 31                	push   $0x31
  80168c:	ff 75 08             	pushl  0x8(%ebp)
  80168f:	e8 5d ff ff ff       	call   8015f1 <forkchild>
...
int
main(void) {
  80169a:	8d 4c 24 04          	lea    0x4(%esp),%ecx
  80169e:	83 e4 f0             	and    $0xfffffff0,%esp
  8016a1:	ff 71 fc             	pushl  -0x4(%ecx)
  8016a4:	55                   	push   %ebp
  ...
  8016ae:	68 90 01 00 00       	push   $0x190
  8016b3:	68 98 1b 80 00       	push   $0x801b98
  8016b8:	e8 18 ef ff ff       	call   8005d5 <cprintf>
  8016bd:	83 c4 10             	add    $0x10,%esp
    sleep(SLEEP_TIME);
  8016c0:	83 ec 0c             	sub    $0xc,%esp
  8016c3:	68 90 01 00 00       	push   $0x190
  8016c8:	e8 91 f2 ff ff       	call   80095e <sleep>
  8016cd:	83 c4 10             	add    $0x10,%esp
    forktree("");
  8016d0:	83 ec 0c             	sub    $0xc,%esp
  8016d3:	68 be 1b 80 00       	push   $0x801bbe
  8016d8:	e8 7b ff ff ff       	call   801658 <forktree>
  ...
  8016e8:	c9                   	leave  
  8016e9:	8d 61 fc             	lea    -0x4(%ecx),%esp
  8016ec:	c3                   	ret    
