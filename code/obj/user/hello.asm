...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800035:	68 60 16 80 00       	push   $0x801660
  ...
  800057:	68 7a 16 80 00       	push   $0x80167a
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  800083:	68 7c 16 80 00       	push   $0x80167c
  ...
  8000a5:	68 7a 16 80 00       	push   $0x80167a
...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  800509:	68 98 16 80 00       	push   $0x801698
  ...
  80052a:	50                   	push   %eax
  80052b:	68 a3 16 80 00       	push   $0x8016a3
  ...
  800541:	50                   	push   %eax
  800542:	68 b5 16 80 00       	push   $0x8016b5
  ...
  800558:	50                   	push   %eax
  800559:	68 c8 16 80 00       	push   $0x8016c8
  ...
  80056f:	50                   	push   %eax
  800570:	68 db 16 80 00       	push   $0x8016db
...
umain(int argc, char *argv[]) {
  ...
  80073e:	68 ee 16 80 00       	push   $0x8016ee
  ...
  800759:	68 f5 16 80 00       	push   $0x8016f5
  80075e:	6a 1a                	push   $0x1a
  800760:	68 0f 17 80 00       	push   $0x80170f
  ...
  800772:	68 21 17 80 00       	push   $0x801721
  ...
  80078d:	68 29 17 80 00       	push   $0x801729
  800792:	6a 1d                	push   $0x1d
  800794:	68 0f 17 80 00       	push   $0x80170f
...
exit(int error_code) {
  ...
  8008bc:	68 44 17 80 00       	push   $0x801744
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800f7b:	05 64 19 80 00       	add    $0x801964,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  8010cc:	8b 04 85 88 19 80 00 	mov    0x801988(,%eax,4),%eax
  ...
  8011ce:	56                   	push   %esi
  8011cf:	68 7e 19 80 00       	push   $0x80197e
  ...
  8011f7:	75 05                	jne    8011fe <vprintfmt+0x1a3>
                p = "(null)";
  8011f9:	be 81 19 80 00       	mov    $0x801981,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  801605:	68 e0 1a 80 00       	push   $0x801ae0
  80160a:	e8 c6 ef ff ff       	call   8005d5 <cprintf>
  80160f:	83 c4 10             	add    $0x10,%esp
    cprintf("I am process %d.\n", getpid());
  801612:	e8 15 f3 ff ff       	call   80092c <getpid>
  801617:	83 ec 08             	sub    $0x8,%esp
  80161a:	50                   	push   %eax
  80161b:	68 f0 1a 80 00       	push   $0x801af0
  801620:	e8 b0 ef ff ff       	call   8005d5 <cprintf>
  801625:	83 c4 10             	add    $0x10,%esp
    cprintf("hello pass.\n");
  801628:	83 ec 0c             	sub    $0xc,%esp
  80162b:	68 02 1b 80 00       	push   $0x801b02
  801630:	e8 a0 ef ff ff       	call   8005d5 <cprintf>
  801635:	83 c4 10             	add    $0x10,%esp
    return 0;
  801638:	b8 00 00 00 00       	mov    $0x0,%eax
}
  80163d:	8b 4d fc             	mov    -0x4(%ebp),%ecx
  801640:	c9                   	leave  
  801641:	8d 61 fc             	lea    -0x4(%ecx),%esp
  801644:	c3                   	ret    
