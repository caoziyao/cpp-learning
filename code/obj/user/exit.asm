...
exit(int error_code) {
  ...
  8008bc:	68 24 18 80 00       	push   $0x801824
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800f7b:	05 44 1a 80 00       	add    $0x801a44,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  8010cc:	8b 04 85 68 1a 80 00 	mov    0x801a68(,%eax,4),%eax
  ...
  8011ce:	56                   	push   %esi
  8011cf:	68 5e 1a 80 00       	push   $0x801a5e
  ...
  8011f7:	75 05                	jne    8011fe <vprintfmt+0x1a3>
                p = "(null)";
  8011f9:	be 61 1a 80 00       	mov    $0x801a61,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  801605:	68 c0 1b 80 00       	push   $0x801bc0
  80160a:	e8 c6 ef ff ff       	call   8005d5 <cprintf>
  80160f:	83 c4 10             	add    $0x10,%esp
    if ((pid = fork()) == 0) {
  801612:	e8 b4 f2 ff ff       	call   8008cb <fork>
  801617:	89 45 f4             	mov    %eax,-0xc(%ebp)
  80161a:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
  80161e:	75 41                	jne    801661 <main+0x70>
        cprintf("I am the child.\n");
  801620:	83 ec 0c             	sub    $0xc,%esp
  801623:	68 e7 1b 80 00       	push   $0x801be7
  801628:	e8 a8 ef ff ff       	call   8005d5 <cprintf>
  80162d:	83 c4 10             	add    $0x10,%esp
        yield();
  801630:	e8 d3 f2 ff ff       	call   800908 <yield>
        yield();
  801635:	e8 ce f2 ff ff       	call   800908 <yield>
        yield();
  80163a:	e8 c9 f2 ff ff       	call   800908 <yield>
        yield();
  80163f:	e8 c4 f2 ff ff       	call   800908 <yield>
        yield();
  801644:	e8 bf f2 ff ff       	call   800908 <yield>
        yield();
  801649:	e8 ba f2 ff ff       	call   800908 <yield>
        yield();
  80164e:	e8 b5 f2 ff ff       	call   800908 <yield>
        exit(magic);
  801653:	a1 10 20 80 00       	mov    0x802010,%eax
  801658:	83 ec 0c             	sub    $0xc,%esp
  80165b:	50                   	push   %eax
  80165c:	e8 44 f2 ff ff       	call   8008a5 <exit>
    }
    else {
        cprintf("I am parent, fork a child pid %d\n",pid);
  801661:	83 ec 08             	sub    $0x8,%esp
  801664:	ff 75 f4             	pushl  -0xc(%ebp)
  801667:	68 f8 1b 80 00       	push   $0x801bf8
  80166c:	e8 64 ef ff ff       	call   8005d5 <cprintf>
  801671:	83 c4 10             	add    $0x10,%esp
    }
    assert(pid > 0);
  801674:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
  801678:	7f 16                	jg     801690 <main+0x9f>
  80167a:	68 1a 1c 80 00       	push   $0x801c1a
  80167f:	68 22 1c 80 00       	push   $0x801c22
  801684:	6a 18                	push   $0x18
  801686:	68 37 1c 80 00       	push   $0x801c37
  80168b:	e8 90 e9 ff ff       	call   800020 <__panic>
    cprintf("I am the parent, waiting now..\n");
  801690:	83 ec 0c             	sub    $0xc,%esp
  801693:	68 44 1c 80 00       	push   $0x801c44
  801698:	e8 38 ef ff ff       	call   8005d5 <cprintf>
  ...
  8016aa:	e8 40 f2 ff ff       	call   8008ef <waitpid>
  8016af:	83 c4 10             	add    $0x10,%esp
  8016b2:	85 c0                	test   %eax,%eax
  8016b4:	75 0c                	jne    8016c2 <main+0xd1>
  8016b6:	8b 55 f0             	mov    -0x10(%ebp),%edx
  8016b9:	a1 10 20 80 00       	mov    0x802010,%eax
  8016be:	39 c2                	cmp    %eax,%edx
  8016c0:	74 16                	je     8016d8 <main+0xe7>
  8016c2:	68 64 1c 80 00       	push   $0x801c64
  8016c7:	68 22 1c 80 00       	push   $0x801c22
  8016cc:	6a 1b                	push   $0x1b
  8016ce:	68 37 1c 80 00       	push   $0x801c37
  8016d3:	e8 48 e9 ff ff       	call   800020 <__panic>
    assert(waitpid(pid, &code) != 0 && wait() != 0);
  8016d8:	83 ec 08             	sub    $0x8,%esp
  8016db:	8d 45 f0             	lea    -0x10(%ebp),%eax
  8016de:	50                   	push   %eax
  8016df:	ff 75 f4             	pushl  -0xc(%ebp)
  8016e2:	e8 08 f2 ff ff       	call   8008ef <waitpid>
  8016e7:	83 c4 10             	add    $0x10,%esp
  8016ea:	85 c0                	test   %eax,%eax
  8016ec:	74 09                	je     8016f7 <main+0x106>
  8016ee:	e8 e5 f1 ff ff       	call   8008d8 <wait>
  8016f3:	85 c0                	test   %eax,%eax
  8016f5:	75 16                	jne    80170d <main+0x11c>
  8016f7:	68 90 1c 80 00       	push   $0x801c90
  8016fc:	68 22 1c 80 00       	push   $0x801c22
  801701:	6a 1c                	push   $0x1c
  801703:	68 37 1c 80 00       	push   $0x801c37
  801708:	e8 13 e9 ff ff       	call   800020 <__panic>
    cprintf("waitpid %d ok.\n", pid);
  80170d:	83 ec 08             	sub    $0x8,%esp
  801710:	ff 75 f4             	pushl  -0xc(%ebp)
  801713:	68 b8 1c 80 00       	push   $0x801cb8
  801718:	e8 b8 ee ff ff       	call   8005d5 <cprintf>
  80171d:	83 c4 10             	add    $0x10,%esp

    cprintf("exit pass.\n");
  801720:	83 ec 0c             	sub    $0xc,%esp
  801723:	68 c8 1c 80 00       	push   $0x801cc8
  801728:	e8 a8 ee ff ff       	call   8005d5 <cprintf>
  80172d:	83 c4 10             	add    $0x10,%esp
    return 0;
  801730:	b8 00 00 00 00       	mov    $0x0,%eax
}
  801735:	8b 4d fc             	mov    -0x4(%ebp),%ecx
  801738:	c9                   	leave  
  801739:	8d 61 fc             	lea    -0x4(%ecx),%esp
  80173c:	c3                   	ret    
