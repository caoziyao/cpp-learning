...
exit(int error_code) {
  ...
  8008bc:	68 04 18 80 00       	push   $0x801804
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800f7b:	05 24 1a 80 00       	add    $0x801a24,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  8010cc:	8b 04 85 48 1a 80 00 	mov    0x801a48(,%eax,4),%eax
  ...
  8011ce:	56                   	push   %esi
  8011cf:	68 3e 1a 80 00       	push   $0x801a3e
  ...
  8011f7:	75 05                	jne    8011fe <vprintfmt+0x1a3>
                p = "(null)";
  8011f9:	be 41 1a 80 00       	mov    $0x801a41,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  8015ff:	83 ec 14             	sub    $0x14,%esp
    int pid, exit_code;
    if ((pid = fork()) == 0) {
  801602:	e8 c4 f2 ff ff       	call   8008cb <fork>
  801607:	89 45 f0             	mov    %eax,-0x10(%ebp)
  80160a:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
  80160e:	75 35                	jne    801645 <main+0x54>
        cprintf("fork ok.\n");
  801610:	83 ec 0c             	sub    $0xc,%esp
  801613:	68 a0 1b 80 00       	push   $0x801ba0
  801618:	e8 b8 ef ff ff       	call   8005d5 <cprintf>
  80161d:	83 c4 10             	add    $0x10,%esp
        int i;
        for (i = 0; i < 10; i ++) {
  801620:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  801627:	eb 09                	jmp    801632 <main+0x41>
            yield();
  801629:	e8 da f2 ff ff       	call   800908 <yield>
main(void) {
    int pid, exit_code;
    if ((pid = fork()) == 0) {
        cprintf("fork ok.\n");
  ...
  801632:	83 7d f4 09          	cmpl   $0x9,-0xc(%ebp)
  801636:	7e f1                	jle    801629 <main+0x38>
            yield();
        }
        exit(0xbeaf);
  801638:	83 ec 0c             	sub    $0xc,%esp
  80163b:	68 af be 00 00       	push   $0xbeaf
  801640:	e8 60 f2 ff ff       	call   8008a5 <exit>
    }
    assert(pid > 0);
  801645:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
  801649:	7f 16                	jg     801661 <main+0x70>
  80164b:	68 aa 1b 80 00       	push   $0x801baa
  801650:	68 b2 1b 80 00       	push   $0x801bb2
  801655:	6a 0f                	push   $0xf
  801657:	68 c7 1b 80 00       	push   $0x801bc7
  80165c:	e8 bf e9 ff ff       	call   800020 <__panic>
    assert(waitpid(-1, NULL) != 0);
  801661:	83 ec 08             	sub    $0x8,%esp
  801664:	6a 00                	push   $0x0
  801666:	6a ff                	push   $0xffffffff
  801668:	e8 82 f2 ff ff       	call   8008ef <waitpid>
  80166d:	83 c4 10             	add    $0x10,%esp
  801670:	85 c0                	test   %eax,%eax
  801672:	75 16                	jne    80168a <main+0x99>
  801674:	68 d5 1b 80 00       	push   $0x801bd5
  801679:	68 b2 1b 80 00       	push   $0x801bb2
  80167e:	6a 10                	push   $0x10
  801680:	68 c7 1b 80 00       	push   $0x801bc7
  801685:	e8 96 e9 ff ff       	call   800020 <__panic>
    assert(waitpid(pid, (void *)0xC0000000) != 0);
  80168a:	83 ec 08             	sub    $0x8,%esp
  80168d:	68 00 00 00 c0       	push   $0xc0000000
  801692:	ff 75 f0             	pushl  -0x10(%ebp)
  801695:	e8 55 f2 ff ff       	call   8008ef <waitpid>
  80169a:	83 c4 10             	add    $0x10,%esp
  80169d:	85 c0                	test   %eax,%eax
  80169f:	75 16                	jne    8016b7 <main+0xc6>
  8016a1:	68 ec 1b 80 00       	push   $0x801bec
  8016a6:	68 b2 1b 80 00       	push   $0x801bb2
  8016ab:	6a 11                	push   $0x11
  8016ad:	68 c7 1b 80 00       	push   $0x801bc7
  8016b2:	e8 69 e9 ff ff       	call   800020 <__panic>
  ...
  8016c1:	e8 29 f2 ff ff       	call   8008ef <waitpid>
  8016c6:	83 c4 10             	add    $0x10,%esp
  8016c9:	85 c0                	test   %eax,%eax
  8016cb:	75 0a                	jne    8016d7 <main+0xe6>
  8016cd:	8b 45 ec             	mov    -0x14(%ebp),%eax
  8016d0:	3d af be 00 00       	cmp    $0xbeaf,%eax
  8016d5:	74 16                	je     8016ed <main+0xfc>
  8016d7:	68 14 1c 80 00       	push   $0x801c14
  8016dc:	68 b2 1b 80 00       	push   $0x801bb2
  8016e1:	6a 12                	push   $0x12
  8016e3:	68 c7 1b 80 00       	push   $0x801bc7
  8016e8:	e8 33 e9 ff ff       	call   800020 <__panic>
    cprintf("badarg pass.\n");
  8016ed:	83 ec 0c             	sub    $0xc,%esp
  8016f0:	68 49 1c 80 00       	push   $0x801c49
  8016f5:	e8 db ee ff ff       	call   8005d5 <cprintf>
  8016fa:	83 c4 10             	add    $0x10,%esp
    return 0;
  8016fd:	b8 00 00 00 00       	mov    $0x0,%eax
}
  801702:	8b 4d fc             	mov    -0x4(%ebp),%ecx
  801705:	c9                   	leave  
  801706:	8d 61 fc             	lea    -0x4(%ecx),%esp
  801709:	c3                   	ret    
