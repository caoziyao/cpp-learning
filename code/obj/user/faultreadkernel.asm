...
main(void) {
  ...
  801602:	b8 00 00 c0 fa       	mov    $0xfac00000,%eax
  801607:	8b 00                	mov    (%eax),%eax
  801609:	83 ec 08             	sub    $0x8,%esp
  80160c:	50                   	push   %eax
  80160d:	68 c0 1a 80 00       	push   $0x801ac0
  801612:	e8 be ef ff ff       	call   8005d5 <cprintf>
  801617:	83 c4 10             	add    $0x10,%esp
    panic("FAIL: T.T\n");
  80161a:	83 ec 04             	sub    $0x4,%esp
  80161d:	68 de 1a 80 00       	push   $0x801ade
  801622:	6a 07                	push   $0x7
  801624:	68 e9 1a 80 00       	push   $0x801ae9
