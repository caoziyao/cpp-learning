...
obj/__user_sfs_filetest1.out:     file format elf32-i386
...
umain(int argc, char *argv[]) {
  ...
  8007aa:	e8 11 0f 00 00       	call   8016c0 <main>
...
static int safe_open(const char *path, int open_flags)
{
  ...
  801601:	e8 a6 ed ff ff       	call   8003ac <open>
  801606:	83 c4 10             	add    $0x10,%esp
  801609:	89 45 f4             	mov    %eax,-0xc(%ebp)
	printf("fd is %d\n",fd);
  80160c:	83 ec 04             	sub    $0x4,%esp
  80160f:	ff 75 f4             	pushl  -0xc(%ebp)
  801612:	68 a0 1b 80 00       	push   $0x801ba0
  801617:	6a 01                	push   $0x1
  801619:	e8 8a f0 ff ff       	call   8006a8 <fprintf>
  80161e:	83 c4 10             	add    $0x10,%esp
	assert(fd >= 0);
  801621:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
  801625:	79 16                	jns    80163d <safe_open+0x4c>
  801627:	68 aa 1b 80 00       	push   $0x801baa
  80162c:	68 b2 1b 80 00       	push   $0x801bb2
  801631:	6a 10                	push   $0x10
  801633:	68 c7 1b 80 00       	push   $0x801bc7
...
static struct stat *safe_fstat(int fd)
{
  ...
  801648:	a1 10 20 80 00       	mov    0x802010,%eax
  80164d:	83 ec 08             	sub    $0x8,%esp
  801650:	50                   	push   %eax
  801651:	ff 75 08             	pushl  0x8(%ebp)
  801654:	e8 d6 ed ff ff       	call   80042f <fstat>
  801659:	83 c4 10             	add    $0x10,%esp
  80165c:	89 45 f4             	mov    %eax,-0xc(%ebp)
	assert(ret == 0);
  80165f:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
  801663:	74 16                	je     80167b <safe_fstat+0x39>
  801665:	68 dc 1b 80 00       	push   $0x801bdc
  80166a:	68 b2 1b 80 00       	push   $0x801bb2
  80166f:	6a 18                	push   $0x18
  801671:	68 c7 1b 80 00       	push   $0x801bc7
  801676:	e8 a5 e9 ff ff       	call   800020 <__panic>
	return stat;
  80167b:	a1 10 20 80 00       	mov    0x802010,%eax
}
  801680:	c9                   	leave  
  801681:	c3                   	ret    
...
static void safe_read(int fd, void *data, size_t len)
{
  ...
  801694:	e8 42 ed ff ff       	call   8003db <read>
  801699:	83 c4 10             	add    $0x10,%esp
  80169c:	89 45 f4             	mov    %eax,-0xc(%ebp)
	assert(ret == len);
  80169f:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8016a2:	3b 45 10             	cmp    0x10(%ebp),%eax
  8016a5:	74 16                	je     8016bd <safe_read+0x3b>
  8016a7:	68 e5 1b 80 00       	push   $0x801be5
  8016ac:	68 b2 1b 80 00       	push   $0x801bb2
  8016b1:	6a 20                	push   $0x20
  8016b3:	68 c7 1b 80 00       	push   $0x801bc7
  8016b8:	e8 63 e9 ff ff       	call   800020 <__panic>
}
  8016bd:	90                   	nop
  8016be:	c9                   	leave  
  8016bf:	c3                   	ret    
...
int main(void)
{
  8016c0:	8d 4c 24 04          	lea    0x4(%esp),%ecx
  8016c4:	83 e4 f0             	and    $0xfffffff0,%esp
  8016c7:	ff 71 fc             	pushl  -0x4(%ecx)
  8016ca:	55                   	push   %ebp
  ...
  8016d6:	68 f0 1b 80 00       	push   $0x801bf0
  8016db:	e8 11 ff ff ff       	call   8015f1 <safe_open>
  ...
  8016ec:	e8 51 ff ff ff       	call   801642 <safe_fstat>
  ...
  8016fa:	68 fe 1b 80 00       	push   $0x801bfe
  8016ff:	6a 01                	push   $0x1
  801701:	e8 a2 ef ff ff       	call   8006a8 <fprintf>
  ...
  801711:	c9                   	leave  
  801712:	8d 61 fc             	lea    -0x4(%ecx),%esp
  801715:	c3                   	ret    
