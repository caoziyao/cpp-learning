...
umain(int argc, char *argv[]) {
  ...
  8007aa:	e8 95 0e 00 00       	call   801644 <main>
...
sleepy(int pid) {
  ...
  8015f4:	83 ec 18             	sub    $0x18,%esp
    int i, time = 100;
  8015f7:	c7 45 f0 64 00 00 00 	movl   $0x64,-0x10(%ebp)
    for (i = 0; i < 10; i ++) {
  8015fe:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  801605:	eb 2d                	jmp    801634 <sleepy+0x43>
        sleep(time);
  801607:	8b 45 f0             	mov    -0x10(%ebp),%eax
  80160a:	83 ec 0c             	sub    $0xc,%esp
  80160d:	50                   	push   %eax
  80160e:	e8 4b f3 ff ff       	call   80095e <sleep>
  801613:	83 c4 10             	add    $0x10,%esp
        cprintf("sleep %d x %d slices.\n", i + 1, time);
  801616:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801619:	83 c0 01             	add    $0x1,%eax
  80161c:	83 ec 04             	sub    $0x4,%esp
  80161f:	ff 75 f0             	pushl  -0x10(%ebp)
  801622:	50                   	push   %eax
  801623:	68 80 1b 80 00       	push   $0x801b80
...
sleepy(int pid) {
  ...
  801634:	83 7d f4 09          	cmpl   $0x9,-0xc(%ebp)
  801638:	7e cd                	jle    801607 <sleepy+0x16>
        sleep(time);
        cprintf("sleep %d x %d slices.\n", i + 1, time);
    }
    exit(0);
  ...
  80163f:	e8 61 f2 ff ff       	call   8008a5 <exit>
...
int
main(void) {
  801644:	8d 4c 24 04          	lea    0x4(%esp),%ecx
  801648:	83 e4 f0             	and    $0xfffffff0,%esp
  80164b:	ff 71 fc             	pushl  -0x4(%ecx)
  80164e:	55                   	push   %ebp
  80164f:	89 e5                	mov    %esp,%ebp
  801651:	51                   	push   %ecx
  801652:	83 ec 14             	sub    $0x14,%esp
    unsigned int time = gettime_msec();
  801655:	e8 1a f3 ff ff       	call   800974 <gettime_msec>
  80165a:	89 45 f4             	mov    %eax,-0xc(%ebp)
    int pid1, exit_code;

    if ((pid1 = fork()) == 0) {
  80165d:	e8 69 f2 ff ff       	call   8008cb <fork>
  801662:	89 45 f0             	mov    %eax,-0x10(%ebp)
  801665:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
  801669:	75 0e                	jne    801679 <main+0x35>
        sleepy(pid1);
  80166b:	83 ec 0c             	sub    $0xc,%esp
  80166e:	ff 75 f0             	pushl  -0x10(%ebp)
  801671:	e8 7b ff ff ff       	call   8015f1 <sleepy>
  ...
  801683:	e8 67 f2 ff ff       	call   8008ef <waitpid>
  801688:	83 c4 10             	add    $0x10,%esp
  80168b:	85 c0                	test   %eax,%eax
  80168d:	75 07                	jne    801696 <main+0x52>
  80168f:	8b 45 ec             	mov    -0x14(%ebp),%eax
  801692:	85 c0                	test   %eax,%eax
  801694:	74 16                	je     8016ac <main+0x68>
  801696:	68 98 1b 80 00       	push   $0x801b98
  80169b:	68 c9 1b 80 00       	push   $0x801bc9
  8016a0:	6a 17                	push   $0x17
  8016a2:	68 de 1b 80 00       	push   $0x801bde
  8016a7:	e8 74 e9 ff ff       	call   800020 <__panic>
    cprintf("use %04d msecs.\n", gettime_msec() - time);
  8016ac:	e8 c3 f2 ff ff       	call   800974 <gettime_msec>
  8016b1:	2b 45 f4             	sub    -0xc(%ebp),%eax
  8016b4:	83 ec 08             	sub    $0x8,%esp
  8016b7:	50                   	push   %eax
  8016b8:	68 eb 1b 80 00       	push   $0x801beb
  8016bd:	e8 13 ef ff ff       	call   8005d5 <cprintf>
  8016c2:	83 c4 10             	add    $0x10,%esp
    cprintf("sleep pass.\n");
  8016c5:	83 ec 0c             	sub    $0xc,%esp
  8016c8:	68 fc 1b 80 00       	push   $0x801bfc
  8016cd:	e8 03 ef ff ff       	call   8005d5 <cprintf>
  ...
  8016dd:	c9                   	leave  
  8016de:	8d 61 fc             	lea    -0x4(%ecx),%esp
  8016e1:	c3                   	ret    
