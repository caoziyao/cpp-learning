...
exit(int error_code) {
  ...
  8008bc:	68 84 17 80 00       	push   $0x801784
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800f7b:	05 a4 19 80 00       	add    $0x8019a4,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  8010cc:	8b 04 85 c8 19 80 00 	mov    0x8019c8(,%eax,4),%eax
  ...
  8011ce:	56                   	push   %esi
  8011cf:	68 be 19 80 00       	push   $0x8019be
  ...
  8011f7:	75 05                	jne    8011fe <vprintfmt+0x1a3>
                p = "(null)";
  8011f9:	be c1 19 80 00       	mov    $0x8019c1,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  80160e:	75 1a                	jne    80162a <main+0x39>
        sleep(~0);
  801610:	83 ec 0c             	sub    $0xc,%esp
  801613:	6a ff                	push   $0xffffffff
  801615:	e8 44 f3 ff ff       	call   80095e <sleep>
  80161a:	83 c4 10             	add    $0x10,%esp
        exit(0xdead);
  80161d:	83 ec 0c             	sub    $0xc,%esp
  801620:	68 ad de 00 00       	push   $0xdead
  801625:	e8 7b f2 ff ff       	call   8008a5 <exit>
    }
    assert(pid > 0);
  80162a:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
  80162e:	7f 16                	jg     801646 <main+0x55>
  801630:	68 20 1b 80 00       	push   $0x801b20
  801635:	68 28 1b 80 00       	push   $0x801b28
  80163a:	6a 0b                	push   $0xb
  80163c:	68 3d 1b 80 00       	push   $0x801b3d
  801641:	e8 da e9 ff ff       	call   800020 <__panic>

    sleep(100);
  801646:	83 ec 0c             	sub    $0xc,%esp
  801649:	6a 64                	push   $0x64
  80164b:	e8 0e f3 ff ff       	call   80095e <sleep>
  801650:	83 c4 10             	add    $0x10,%esp
    assert(kill(pid) == 0);
  801653:	83 ec 0c             	sub    $0xc,%esp
  801656:	ff 75 f4             	pushl  -0xc(%ebp)
  801659:	e8 b8 f2 ff ff       	call   800916 <kill>
  80165e:	83 c4 10             	add    $0x10,%esp
  801661:	85 c0                	test   %eax,%eax
  801663:	74 16                	je     80167b <main+0x8a>
  801665:	68 4e 1b 80 00       	push   $0x801b4e
  80166a:	68 28 1b 80 00       	push   $0x801b28
  80166f:	6a 0e                	push   $0xe
  801671:	68 3d 1b 80 00       	push   $0x801b3d
  801676:	e8 a5 e9 ff ff       	call   800020 <__panic>
    cprintf("sleepkill pass.\n");
  80167b:	83 ec 0c             	sub    $0xc,%esp
  80167e:	68 5d 1b 80 00       	push   $0x801b5d
  ...
  801693:	c9                   	leave  
  801694:	8d 61 fc             	lea    -0x4(%ecx),%esp
  801697:	c3                   	ret    
