...
umain(int argc, char *argv[]) {
  ...
  8007aa:	e8 76 10 00 00       	call   801825 <main>
...
exit(int error_code) {
  ...
  8008bc:	68 c4 1a 80 00       	push   $0x801ac4
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800f7b:	05 e4 1c 80 00       	add    $0x801ce4,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  8010cc:	8b 04 85 08 1d 80 00 	mov    0x801d08(,%eax,4),%eax
  ...
  8011ce:	56                   	push   %esi
  8011cf:	68 fe 1c 80 00       	push   $0x801cfe
  ...
  8011f7:	75 05                	jne    8011fe <vprintfmt+0x1a3>
                p = "(null)";
  8011f9:	be 01 1d 80 00       	mov    $0x801d01,%esi
            }
            if (width > 0 && padc != '-') {
...
work(unsigned int times) {
  ...
  8015f8:	c7 45 e8 0a 00 00 00 	movl   $0xa,-0x18(%ebp)
    for (i = 0; i < size; i ++) {
  8015ff:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  801606:	eb 65                	jmp    80166d <work+0x7c>
        for (j = 0; j < size; j ++) {
  801608:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  80160f:	eb 50                	jmp    801661 <work+0x70>
            mata[i][j] = matb[i][j] = 1;
  ...
  801656:	89 0c 85 40 20 80 00 	mov    %ecx,0x802040(,%eax,4)
...
work(unsigned int times) {
    ...
    for (i = 0; i < size; i ++) {
        for (j = 0; j < size; j ++) {
  80165d:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
  801661:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801664:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  801667:	7c a8                	jl     801611 <work+0x20>
static int matc[MATSIZE][MATSIZE];
...
work(unsigned int times) {
    int i, j, k, size = MATSIZE;
    for (i = 0; i < size; i ++) {
  801669:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  80166d:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801670:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  801673:	7c 93                	jl     801608 <work+0x17>
        for (j = 0; j < size; j ++) {
            mata[i][j] = matb[i][j] = 1;
        }
    }
    ...
    yield();
  801675:	e8 8e f2 ff ff       	call   800908 <yield>

    cprintf("pid %d is running (%d times)!.\n", getpid(), times);
  80167a:	e8 ad f2 ff ff       	call   80092c <getpid>
  80167f:	83 ec 04             	sub    $0x4,%esp
  801682:	ff 75 08             	pushl  0x8(%ebp)
  801685:	50                   	push   %eax
  801686:	68 60 1e 80 00       	push   $0x801e60
  80168b:	e8 45 ef ff ff       	call   8005d5 <cprintf>
  801690:	83 c4 10             	add    $0x10,%esp

    while (times -- > 0) {
  801693:	e9 5c 01 00 00       	jmp    8017f4 <work+0x203>
        for (i = 0; i < size; i ++) {
  801698:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  80169f:	e9 b6 00 00 00       	jmp    80175a <work+0x169>
            for (j = 0; j < size; j ++) {
  8016a4:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  8016ab:	e9 9a 00 00 00       	jmp    80174a <work+0x159>
                matc[i][j] = 0;
  ...
  8016c1:	c7 04 85 80 23 80 00 	movl   $0x0,0x802380(,%eax,4)
  8016c8:	00 00 00 00 
                for (k = 0; k < size; k ++) {
  8016cc:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  8016d3:	eb 69                	jmp    80173e <work+0x14d>
  ...
  8016e6:	8b 0c 85 80 23 80 00 	mov    0x802380(,%eax,4),%ecx
    ...
    while (times -- > 0) {
        for (i = 0; i < size; i ++) {
            for (j = 0; j < size; j ++) {
                matc[i][j] = 0;
                for (k = 0; k < size; k ++) {
  80173a:	83 45 ec 01          	addl   $0x1,-0x14(%ebp)
  80173e:	8b 45 ec             	mov    -0x14(%ebp),%eax
  801741:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  801744:	7c 8f                	jl     8016d5 <work+0xe4>
    ...
    while (times -- > 0) {
        for (i = 0; i < size; i ++) {
            for (j = 0; j < size; j ++) {
  801746:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
  80174a:	8b 45 f0             	mov    -0x10(%ebp),%eax
  80174d:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  801750:	0f 8c 5a ff ff ff    	jl     8016b0 <work+0xbf>
    yield();
    ...
    while (times -- > 0) {
        for (i = 0; i < size; i ++) {
  801756:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  80175a:	8b 45 f4             	mov    -0xc(%ebp),%eax
  80175d:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  801760:	0f 8c 3e ff ff ff    	jl     8016a4 <work+0xb3>
                for (k = 0; k < size; k ++) {
                    matc[i][j] += mata[i][k] * matb[k][j];
                }
            }
        ...
        for (i = 0; i < size; i ++) {
  801766:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  80176d:	eb 79                	jmp    8017e8 <work+0x1f7>
            for (j = 0; j < size; j ++) {
  80176f:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  801776:	eb 64                	jmp    8017dc <work+0x1eb>
  ...
  801789:	8b 0c 85 80 23 80 00 	mov    0x802380(,%eax,4),%ecx
  801790:	8b 55 f4             	mov    -0xc(%ebp),%edx
  801793:	89 d0                	mov    %edx,%eax
  801795:	c1 e0 02             	shl    $0x2,%eax
  801798:	01 d0                	add    %edx,%eax
  80179a:	01 c0                	add    %eax,%eax
  80179c:	8b 55 f0             	mov    -0x10(%ebp),%edx
  80179f:	01 d0                	add    %edx,%eax
  8017a1:	89 0c 85 e0 21 80 00 	mov    %ecx,0x8021e0(,%eax,4)
  ...
  8017b9:	8b 0c 85 e0 21 80 00 	mov    0x8021e0(,%eax,4),%ecx
  8017c0:	8b 55 f4             	mov    -0xc(%ebp),%edx
  8017c3:	89 d0                	mov    %edx,%eax
  8017c5:	c1 e0 02             	shl    $0x2,%eax
  8017c8:	01 d0                	add    %edx,%eax
  8017ca:	01 c0                	add    %eax,%eax
  8017cc:	8b 55 f0             	mov    -0x10(%ebp),%edx
  8017cf:	01 d0                	add    %edx,%eax
  8017d1:	89 0c 85 40 20 80 00 	mov    %ecx,0x802040(,%eax,4)
                    matc[i][j] += mata[i][k] * matb[k][j];
                }
            }
        }
        for (i = 0; i < size; i ++) {
            for (j = 0; j < size; j ++) {
  8017d8:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
  8017dc:	8b 45 f0             	mov    -0x10(%ebp),%eax
  8017df:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  8017e2:	7c 94                	jl     801778 <work+0x187>
                for (k = 0; k < size; k ++) {
                    matc[i][j] += mata[i][k] * matb[k][j];
                }
            }
        ...
        for (i = 0; i < size; i ++) {
  8017e4:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  8017e8:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8017eb:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  8017ee:	0f 8c 7b ff ff ff    	jl     80176f <work+0x17e>
  ...
  8017fa:	89 55 08             	mov    %edx,0x8(%ebp)
  8017fd:	85 c0                	test   %eax,%eax
  8017ff:	0f 85 93 fe ff ff    	jne    801698 <work+0xa7>
            for (j = 0; j < size; j ++) {
                mata[i][j] = matb[i][j] = matc[i][j];
            }
        }
    ...
    cprintf("pid %d done!.\n", getpid());
  801805:	e8 22 f1 ff ff       	call   80092c <getpid>
  80180a:	83 ec 08             	sub    $0x8,%esp
  80180d:	50                   	push   %eax
  80180e:	68 80 1e 80 00       	push   $0x801e80
  801813:	e8 bd ed ff ff       	call   8005d5 <cprintf>
  801818:	83 c4 10             	add    $0x10,%esp
    exit(0);
  80181b:	83 ec 0c             	sub    $0xc,%esp
  80181e:	6a 00                	push   $0x0
  801820:	e8 80 f0 ff ff       	call   8008a5 <exit>
...
int
main(void) {
  801825:	8d 4c 24 04          	lea    0x4(%esp),%ecx
  801829:	83 e4 f0             	and    $0xfffffff0,%esp
  80182c:	ff 71 fc             	pushl  -0x4(%ecx)
  80182f:	55                   	push   %ebp
  801830:	89 e5                	mov    %esp,%ebp
  801832:	53                   	push   %ebx
  801833:	51                   	push   %ecx
  801834:	83 ec 10             	sub    $0x10,%esp
  801837:	89 e0                	mov    %esp,%eax
  801839:	89 c3                	mov    %eax,%ebx
    int pids[total];
  80183b:	b8 15 00 00 00       	mov    $0x15,%eax
  801840:	83 e8 01             	sub    $0x1,%eax
  801843:	89 45 f0             	mov    %eax,-0x10(%ebp)
  801846:	b8 15 00 00 00       	mov    $0x15,%eax
  80184b:	c1 e0 02             	shl    $0x2,%eax
  80184e:	8d 50 03             	lea    0x3(%eax),%edx
  801851:	b8 10 00 00 00       	mov    $0x10,%eax
  801856:	83 e8 01             	sub    $0x1,%eax
  801859:	01 d0                	add    %edx,%eax
  80185b:	b9 10 00 00 00       	mov    $0x10,%ecx
  801860:	ba 00 00 00 00       	mov    $0x0,%edx
  801865:	f7 f1                	div    %ecx
  801867:	6b c0 10             	imul   $0x10,%eax,%eax
  80186a:	29 c4                	sub    %eax,%esp
  80186c:	89 e0                	mov    %esp,%eax
  80186e:	83 c0 03             	add    $0x3,%eax
  801871:	c1 e8 02             	shr    $0x2,%eax
  801874:	c1 e0 02             	shl    $0x2,%eax
  801877:	89 45 ec             	mov    %eax,-0x14(%ebp)
    memset(pids, 0, sizeof(pids));
  80187a:	b8 15 00 00 00       	mov    $0x15,%eax
  80187f:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
  801886:	8b 45 ec             	mov    -0x14(%ebp),%eax
  801889:	83 ec 04             	sub    $0x4,%esp
  80188c:	52                   	push   %edx
  80188d:	6a 00                	push   $0x0
  80188f:	50                   	push   %eax
  801890:	e8 84 f4 ff ff       	call   800d19 <memset>
  801895:	83 c4 10             	add    $0x10,%esp

    int i;
    for (i = 0; i < total; i ++) {
  801898:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  80189f:	eb 78                	jmp    801919 <main+0xf4>
        if ((pids[i] = fork()) == 0) {
  8018a1:	e8 25 f0 ff ff       	call   8008cb <fork>
  8018a6:	89 c1                	mov    %eax,%ecx
  8018a8:	8b 45 ec             	mov    -0x14(%ebp),%eax
  8018ab:	8b 55 f4             	mov    -0xc(%ebp),%edx
  8018ae:	89 0c 90             	mov    %ecx,(%eax,%edx,4)
  8018b1:	8b 45 ec             	mov    -0x14(%ebp),%eax
  8018b4:	8b 55 f4             	mov    -0xc(%ebp),%edx
  8018b7:	8b 04 90             	mov    (%eax,%edx,4),%eax
  8018ba:	85 c0                	test   %eax,%eax
  8018bc:	75 4a                	jne    801908 <main+0xe3>
            srand(i * i);
  8018be:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8018c1:	0f af 45 f4          	imul   -0xc(%ebp),%eax
  8018c5:	83 ec 0c             	sub    $0xc,%esp
  8018c8:	50                   	push   %eax
  8018c9:	e8 0a fd ff ff       	call   8015d8 <srand>
  8018ce:	83 c4 10             	add    $0x10,%esp
            int times = (((unsigned int)rand()) % total);
  8018d1:	e8 43 fc ff ff       	call   801519 <rand>
  8018d6:	ba 15 00 00 00       	mov    $0x15,%edx
  8018db:	89 d1                	mov    %edx,%ecx
  8018dd:	ba 00 00 00 00       	mov    $0x0,%edx
  8018e2:	f7 f1                	div    %ecx
  8018e4:	89 d0                	mov    %edx,%eax
  8018e6:	89 45 e8             	mov    %eax,-0x18(%ebp)
            times = (times * times + 10) * 100;
  8018e9:	8b 45 e8             	mov    -0x18(%ebp),%eax
  8018ec:	0f af 45 e8          	imul   -0x18(%ebp),%eax
  8018f0:	83 c0 0a             	add    $0xa,%eax
  8018f3:	6b c0 64             	imul   $0x64,%eax,%eax
  8018f6:	89 45 e8             	mov    %eax,-0x18(%ebp)
            work(times);
  8018f9:	8b 45 e8             	mov    -0x18(%ebp),%eax
  8018fc:	83 ec 0c             	sub    $0xc,%esp
  8018ff:	50                   	push   %eax
  801900:	e8 ec fc ff ff       	call   8015f1 <work>
  801905:	83 c4 10             	add    $0x10,%esp
        }
        if (pids[i] < 0) {
  801908:	8b 45 ec             	mov    -0x14(%ebp),%eax
  80190b:	8b 55 f4             	mov    -0xc(%ebp),%edx
  80190e:	8b 04 90             	mov    (%eax,%edx,4),%eax
  801911:	85 c0                	test   %eax,%eax
  801913:	78 6d                	js     801982 <main+0x15d>
main(void) {
    int pids[total];
    memset(pids, 0, sizeof(pids));
    ...
    int i;
    for (i = 0; i < total; i ++) {
  801915:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  801919:	b8 15 00 00 00       	mov    $0x15,%eax
  80191e:	39 45 f4             	cmp    %eax,-0xc(%ebp)
  801921:	0f 8c 7a ff ff ff    	jl     8018a1 <main+0x7c>
        if (pids[i] < 0) {
            goto failed;
        }
    }
  ...
  80192a:	68 94 1e 80 00       	push   $0x801e94
  80192f:	e8 a1 ec ff ff       	call   8005d5 <cprintf>
  801934:	83 c4 10             	add    $0x10,%esp

    for (i = 0; i < total; i ++) {
  801937:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  80193e:	eb 1f                	jmp    80195f <main+0x13a>
        if (wait() != 0) {
  801940:	e8 93 ef ff ff       	call   8008d8 <wait>
  801945:	85 c0                	test   %eax,%eax
  801947:	74 12                	je     80195b <main+0x136>
            cprintf("wait failed.\n");
  801949:	83 ec 0c             	sub    $0xc,%esp
  80194c:	68 9e 1e 80 00       	push   $0x801e9e
  801951:	e8 7f ec ff ff       	call   8005d5 <cprintf>
  801956:	83 c4 10             	add    $0x10,%esp
            goto failed;
  801959:	eb 28                	jmp    801983 <main+0x15e>
        }
    }
    ...
    for (i = 0; i < total; i ++) {
  80195b:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  80195f:	b8 15 00 00 00       	mov    $0x15,%eax
  801964:	39 45 f4             	cmp    %eax,-0xc(%ebp)
  801967:	7c d7                	jl     801940 <main+0x11b>
            cprintf("wait failed.\n");
            goto failed;
        }
    }
  ...
  80196c:	68 ac 1e 80 00       	push   $0x801eac
  801971:	e8 5f ec ff ff       	call   8005d5 <cprintf>
  801976:	83 c4 10             	add    $0x10,%esp
    return 0;
  801979:	b8 00 00 00 00       	mov    $0x0,%eax
  80197e:	89 dc                	mov    %ebx,%esp
  801980:	eb 4e                	jmp    8019d0 <main+0x1ab>
            int times = (((unsigned int)rand()) % total);
            times = (times * times + 10) * 100;
            work(times);
        }
...
failed:
    for (i = 0; i < total; i ++) {
  8019ae:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  8019b2:	b8 15 00 00 00       	mov    $0x15,%eax
  8019b7:	39 45 f4             	cmp    %eax,-0xc(%ebp)
  8019ba:	7c d0                	jl     80198c <main+0x167>
        if (pids[i] > 0) {
            kill(pids[i]);
        }
    }
  ...
  8019bf:	68 ba 1e 80 00       	push   $0x801eba
  8019c4:	6a 52                	push   $0x52
  8019c6:	68 c5 1e 80 00       	push   $0x801ec5
  8019cb:	e8 50 e6 ff ff       	call   800020 <__panic>
}
  8019d0:	8d 65 f8             	lea    -0x8(%ebp),%esp
  8019d3:	59                   	pop    %ecx
  8019d4:	5b                   	pop    %ebx
  8019d5:	5d                   	pop    %ebp
  8019d6:	8d 61 fc             	lea    -0x4(%ecx),%esp
  8019d9:	c3                   	ret    
