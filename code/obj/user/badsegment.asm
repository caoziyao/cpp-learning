...
exit(int error_code) {
  ...
  8008bc:	68 04 17 80 00       	push   $0x801704
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800f7b:	05 24 19 80 00       	add    $0x801924,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  8010cc:	8b 04 85 48 19 80 00 	mov    0x801948(,%eax,4),%eax
  ...
  8011ce:	56                   	push   %esi
  8011cf:	68 3e 19 80 00       	push   $0x80193e
  ...
  8011f7:	75 05                	jne    8011fe <vprintfmt+0x1a3>
                p = "(null)";
  8011f9:	be 41 19 80 00       	mov    $0x801941,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  801602:	66 b8 28 00          	mov    $0x28,%ax
  801606:	8e d8                	mov    %eax,%ds
    panic("FAIL: T.T\n");
  801608:	83 ec 04             	sub    $0x4,%esp
  80160b:	68 a0 1a 80 00       	push   $0x801aa0
  801610:	6a 09                	push   $0x9
  801612:	68 ab 1a 80 00       	push   $0x801aab
  801617:	e8 04 ea ff ff       	call   800020 <__panic>
